...
<div class="row">
      <form:form method="POST" commandName="leave" 
						action="${pageContext.request.contextPath}/viewleaveback">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Leave type ID</label>
									<form:input path="leaveTypeId" name="leaveTypeId" value="${p.leaveTypeId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									<label class="label1">Leave Name</label>
									<form:input path="leaveName" name="leaveName" value="${p.leaveName}" type="text" class="form-control" readonly="true" />
										 ...
										 <div class="form-group">
										 <label class="label1">Leave Code</label>
                	                     <form:input path="leaveCode" value="${p.leaveCode}" name="leaveCode" type="text" class="form-control" readonly="true"/>  
		    	                        </div>
								
								<div class="form-group">
								<label class="label1">Leave Count</label>
									<form:input path="leaveCount" name="leaveCount" value="${p.leaveCount}" type="text" class="form-control" readonly="true"
										 />
								</div>
							

								<div class="form-group">
									<label class="label1">Reset Date</label>
								   
								   <form:input path="resetDate" value="${p.resetDate}" name="resetDate" type="text" class="form-control" readonly="true" />
								</div>
								
								
								
								<div class="form-group">
									<label class="label1">Enable leave</label>
									<%-- <form:input path="gender" type="text" class="form-control" name="gender" /> --%>
									<form:input path="enableLeave" value="${p.enableLeave}" name="enableLeave" type="text" class="form-control" readonly="true" />
								</div>
								...
								<div class="form-group">
									...
									<%-- <form:input path="gender" type="text" class="form-control" name="gender" /> --%>
									<form:input path="status" value="${p.status}" name="status" type="text" class="form-control" readonly="true" />
								</div>
