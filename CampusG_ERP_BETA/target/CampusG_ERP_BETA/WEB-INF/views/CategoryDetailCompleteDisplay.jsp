...
<div class="row">
      <form:form method="POST" commandName="category" 
						action="${pageContext.request.contextPath}/viewcategoryback">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="categoryId" name="categoryId" value="${p.categoryId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									...
									<form:input path="categoryName" name="categoryName" value="${p.categoryName}" type="text" class="form-control" readonly="true" />
