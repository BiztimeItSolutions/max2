...
<div class="row">
      <form:form method="POST" commandName="course" 
						action="${pageContext.request.contextPath}/viewcourseback">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Course ID</label>
									<form:input path="courseId" name="courseId" value="${p.courseId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									...
									<form:input path="courseName" name="courseName" value="${p.courseName}" type="text" class="form-control" readonly="true" />
										 ...
										 <div class="form-group">
										 <label class="label1">Program Name</label>
                	                     <form:input path="programNamefk" value="${p.programNamefk}" name="programNamefk" type="text" class="form-control" readonly="true"/>  
		    	                        </div>
								
								 <div class="form-group">
										 <label class="label1">Course Code</label>
                	                     <form:input path="code" value="${p.code}" name="code" type="text" class="form-control" readonly="true"/>  
		    	                        </div>
		    	                        
		    	                        
		    	                         <div class="form-group">
										 <label class="label1">Grading System</label>
                	                     <form:input path="grading" value="${p.grading}" name="grading" type="text" class="form-control" readonly="true"/>  
		    	                        </div>
		    	                        
		    	                        
		    	                        <div class="form-group">
										 <label class="label1">Elective</label>
                	                     <form:input path="elective" value="${p.elective}" name="elective" type="text" class="form-control" readonly="true"/>  
		    	                        </div>
