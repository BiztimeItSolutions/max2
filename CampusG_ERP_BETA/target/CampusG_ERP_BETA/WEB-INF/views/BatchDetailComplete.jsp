...
<br/>
<div class="row">
      <form:form method="POST" commandName="batch" 
						action="${pageContext.request.contextPath}/viewbatchback">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Batch ID</label>
									<form:input path="batchId" name="batchId" value="${p.batchId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									<label class="label1">Batch Name</label>
									<form:input path="batchName" name="batchName" value="${p.batchName}" type="text" class="form-control" readonly="true" />
                	                     ...
                	                     <form:input path="courseCodefk" value="${p.courseCodefk}" name="courseCodefk" type="text" class="form-control" readonly="true"/>  
		    	                        </div>
                	                     ...
                	                     <form:input path="startDate" value="${p.startDate}" name="startDate" type="text" class="form-control" readonly="true"/>  
		    	                        </div>
		    	                        
		    	                        
		    	                        <div class="form-group">
										 <label class="label1">End Date</label>
                	                     <form:input path="endDate" value="${p.endDate}" name="endDate" type="text" class="form-control" readonly="true"/>  
		    	                        </div>
