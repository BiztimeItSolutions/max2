...
<br/>
<div class="row">
      <form:form method="POST" commandName="semester" id="validate"
						action="${pageContext.request.contextPath}/Update_Semester_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Semester ID</label>
									<form:input path="semesterId" name="semesterId" value="${p.semesterId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									<label class="label1">Semester Name</label>
									<form:input path="semesterName" name="semesterName" value="${p.semesterName}" type="text" class="form-control"  />
