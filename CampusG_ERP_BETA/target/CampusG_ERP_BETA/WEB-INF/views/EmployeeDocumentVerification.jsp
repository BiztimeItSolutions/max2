...
<form:form method="POST" commandName="employeeCommand" id=""
						action="${pageContext.request.contextPath}/saveEmployeeDocument">
						
					<div class="col-lg-5">
					
                                <div class="form-group">
									<label class="label1">Employee ID</label> <span class="style1"></span>
									<form:input path="employee.employeeId" name="employeeId" type="text" class="form-control" value="${e.employeeId}"/>
								</div>  
								<br/>
                          ...
                          <tr class="odd gradeX">
                         <td align="center">
                         <form:checkbox path="employeeOtherDetail.documentName"  value="${DOCUMENT.documentName}"/>
                   </td>
