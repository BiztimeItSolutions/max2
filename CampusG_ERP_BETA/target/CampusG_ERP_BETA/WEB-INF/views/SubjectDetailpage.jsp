...
<div class="row">
     <form:form method="POST" commandName="subject" id="validate"
						action="${pageContext.request.contextPath}/saveSubjectDetail">
	   <div class="row">			
			...
			<div class="col-lg-5">
                ...
                <div class="form-group">
                     <label class="label1">Subject Name: </label><span class="style1">*</span>
                            <form:input type="text" path="subjectName"  class="form-control" name="subjectName"   /> 
                </div> 
                
                <div class="form-group">
                     <label class="label1">Subject Code: </label><span class="style1">*</span>
                            <form:input type="text" path="subjectCode"  class="form-control" name="subjectCode"   /> 
                </div> 
