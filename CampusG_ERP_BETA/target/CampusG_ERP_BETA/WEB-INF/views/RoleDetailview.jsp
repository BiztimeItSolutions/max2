...
<div id="page-wrapper">
	...
	<h4>View Role Details
	<p align="right"><a href="masterrolepage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.roleId}"/></td> 
                                            <td><c:out value="${c.roleName}"/>
                                          
                                             
                                            
                                        <td>    
                                               <a href="toviewcompleteroleDetail?roleId=${c.roleId}">View</a> / 
										    	<a href="toeditroleDetail?roleId=${c.roleId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeleteroleDetail?roleId=${c.roleId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
