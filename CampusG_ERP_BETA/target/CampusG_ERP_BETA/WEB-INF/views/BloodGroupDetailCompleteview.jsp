...
<div class="row">
	 <div class="col-lg-6">
		  <h4>View Blood group  Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<br/>
<div class="row">
      <form:form method="POST" commandName="blood" 
						action="${pageContext.request.contextPath}/viewbloodgroupback">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="groupId" name="groupId" value="${p.groupId}" type="text" class="form-control"  readonly="true"/>
								...
								<div class="form-group">
									...
									<form:input path="groupName" name="groupName" value="${p.groupName}" type="text" class="form-control" readonly="true" />
