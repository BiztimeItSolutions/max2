...
<c:if test="${success==0}">
	...
	<h4>View Module Details
	<p align="right"><a href="mastermodulepage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.moduleId}"/></td> 
                                            <td><c:out value="${c.moduleName}"/>
                                           <td><c:out value="${c.parentId}"/></td>
                                            <td><c:out value="${c.collegeNamefk}"/></td>
                                            
                                             
                                            
                                        <td>    
                                               <a href="toviewcompletemoduleDetail?moduleId=${c.moduleId}">View</a> / 
										    	<a href="toeditmoduleDetail?moduleId=${c.moduleId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeletemoduleDetail?moduleId=${c.moduleId}" class="deleteconfirmation" ><img src="resources/images/delete16.png" width="16" height="16"></a>
