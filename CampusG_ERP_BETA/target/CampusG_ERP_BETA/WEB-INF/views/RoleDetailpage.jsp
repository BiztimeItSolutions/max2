...
<div class="row">
     <form:form method="POST" commandName="role" id="validate"
						action="${pageContext.request.contextPath}/saveRoleDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Role Name: </label><span class="style1">*</span>
                            <form:input type="text" path="roleName"  class="form-control" name="roleName"   /> 
                </div> 
