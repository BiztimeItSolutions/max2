...
<div id="page-wrapper">
	...
	<h4>View Payment Details
	<p align="right"><a href="masterpaymentpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.paymentmodeId}"/></td> 
                                            <td><c:out value="${c.paymentMode}"/>
                                           
                                            
                                        <td>    
                                               <a href="toviewcompletepaymentDetail?paymentmodeId=${c.paymentmodeId}">View</a> / 
										    	<a href="toeditpaymentmodeDetail?paymentmodeId=${c.paymentmodeId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeletepaymentmodeDetail?paymentmodeId=${c.paymentmodeId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
