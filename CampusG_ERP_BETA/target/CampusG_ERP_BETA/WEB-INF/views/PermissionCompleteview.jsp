...
<div class="row">
	 <div class="col-lg-6">
		  <h4>View Permission Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<br/>
<div class="row">
      <form:form method="POST" commandName="permission" 
						action="${pageContext.request.contextPath}/viewpermissionback">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Permission ID</label>
									<form:input path="permissionId" name="permissionId" value="${p.permissionId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									<label class="label1">Permission Name</label>
									<form:input path="permissionName" name="permissionName" value="${p.permissionName}" type="text" class="form-control" readonly="true" />
