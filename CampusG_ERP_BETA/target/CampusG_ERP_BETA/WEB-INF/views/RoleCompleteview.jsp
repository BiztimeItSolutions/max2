...
<div class="row">
      <form:form method="POST" commandName="role" 
						action="${pageContext.request.contextPath}/viewroleback">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="roleId" name="roleId" value="${p.roleId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									...
									<form:input path="roleName" name="roleName" value="${p.roleName}" type="text" class="form-control"  readonly="true"/>
