...
<br/>
<div class="row">
      <form:form method="POST" commandName="subject" id="validate"
						action="${pageContext.request.contextPath}/Update_Subject_view">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="subjectId" name="subjectId" value="${p.subjectId}" type="text" class="form-control"  />
                             	...
                             	<div class="form-group">
									...
									<form:input path="subjectCode" name="subjectCode" value="${p.subjectCode}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="subjectName" name="subjectName" value="${p.subjectName}" type="text" class="form-control"  />
