...
<div class="row">
      <form:form method="POST" commandName="semester" 
						action="${pageContext.request.contextPath}/viewsemesterback">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="semesterId" name="semesterId" value="${p.semesterId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									...
									<form:input path="semesterName" name="semesterName" value="${p.semesterName}" type="text" class="form-control" readonly="true" />
