...
<div id="page-wrapper">
	...
	<h4>View Blood Group Details
	<p align="right"><a href="masterbloodpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.groupId}"/></td> 
                                            <td><c:out value="${c.groupName}"/>
                                           
                                            
                                        <td>    
                                               <a href="toviewcompletebloodgroupDetail?groupId=${c.groupId}">View</a> / 
										    	<a href="toeditbloodgroupDetail?groupId=${c.groupId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeletebloodgroupDetail?groupId=${c.groupId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
