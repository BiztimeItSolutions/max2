...
<!--Start of Main page-->
    <div id="page-wrapper">
		 ...
		 <div class="row">
               <div class="col-lg-6">
				    <h6>Home > <b>Create Privilage</b></h6>
				</div>
                <!-- /.col-lg-6 -->
          </div>
            <!-- /.row -->
            <br>
              ...
              <form:form method="POST" commandName="privilage" id=""
						action="${pageContext.request.contextPath}/privilage_mapping">
                 ...
                 <div class="form-group">
				  ...
				  <div class="form-group">
                    <label class="label1">Department: </label><span class="style1"></span>
						<form:select path="department" class="form-control" name="department" id="department" onChange="searchOnUse()">
                  ...
                  <div class="form-group">
                    <label class="label1">Privilage: </label><span class="style1"></span>
						<form:select path="privilage" class="form-control" name="privilage" id="privilage">
							<form:option value="none" label="Select Privilage"/>
                        </form:select>
                  </div>
				<br>
...
<%-- <script src="<c:url value="/resources/js/Create_user.js" />"></script> --%>  
	<script src="<c:url value="/resources/js/Privilage_mapping.js" />"></script>
