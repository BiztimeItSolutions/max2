...
<div id="page-wrapper">
	...
	<h4>View Document Details
	<p align="right"><a href="masterdocpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.documentId}"/></td> 
                                            <td><c:out value="${c.documentName}"/>
                                          
                                             
                                            
                                        <td>    
                                               <a href="toviewcompletedocumentDetail?documentId=${c.documentId}">View</a> / 
										    	<a href="toeditdocumentDetail?documentId=${c.documentId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeletedocumentDetail?documentId=${c.documentId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
