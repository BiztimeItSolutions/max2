...
<br/>
<div class="row">
      <form:form method="POST" commandName="receipt" id="validate"
						action="${pageContext.request.contextPath}/Update_Receipt_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Receipt ID</label>
									<form:input path="receiptId" name="receiptId" value="${p.receiptId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									<label class="label1">Receipt Name</label>
									<form:input path="receiptName" name="receiptName" value="${p.receiptName}" type="text" class="form-control"  />
