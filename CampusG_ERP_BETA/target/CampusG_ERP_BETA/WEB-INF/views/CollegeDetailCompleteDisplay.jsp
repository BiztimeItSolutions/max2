...
<br/>
<div class="row">
      <form:form method="POST" commandName="college" 
						action="${pageContext.request.contextPath}/viewcollegeback">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="collegeId" name="collegeId" value="${p.collegeId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									...
									<form:input path="collegeName" name="collegeName" value="${p.collegeName}" type="text" class="form-control" readonly="true" />
                	                     ...
                	                     <form:input path="collegeCode" value="${p.collegeCode}" name="collegeCode" type="text" class="form-control" readonly="true"/>  
		    	                        </div>
								
								<div class="form-group">
								<label class="label1">College Address</label>
									<form:input path="collegeAddress" name="collegeAddress" value="${p.collegeAddress}" type="text" class="form-control" readonly="true"
										 />
								</div>
							

								<div class="form-group">
									<label class="label1">College Phone</label>
								   
								   <form:input path="collegePhone" value="${p.collegePhone}" name="collegePhone" type="text" class="form-control" readonly="true" />
								</div>
								<div class="form-group">
									<label class="label1">College Email</label>
									<%-- <form:input path="gender" type="text" class="form-control" name="gender" /> --%>
									<form:input path="collegeEmail" value="${p.collegeEmail}" name="collegeEmail" type="text" class="form-control" readonly="true" />
								</div>
						
								
								<div class="form-group">
									<label class="label1">University Id</label>
									<%-- <form:input path="gender" type="text" class="form-control" name="gender" /> --%>
									<form:input path="universityId" value="${p.universityId}" name="universityId" type="text" class="form-control" readonly="true" />
								</div>
