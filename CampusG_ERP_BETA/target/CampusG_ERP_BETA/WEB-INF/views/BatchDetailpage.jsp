...
<div class="row">
     <form:form method="POST" commandName="batch" id="validate"
						action="${pageContext.request.contextPath}/saveBatchDetails">
	   <div class="row">			
			...
			<div class="col-lg-5">
                ...
                <div class="form-group">
                     <label class="label1">Batch Name: </label><span class="style1">*</span>
                            <form:input type="text" path="batchName"  class="form-control" name="batchName"   /> 
                </div> 
              ...
              <form:select path="courseId" class="form-control" name="courseId" id="courseCodefk">
                ...
                <div class="form-group">
                     <label class="label1">Start Date: </label><span class="style1">*</span>
                            <form:input type="text" path="startDate"  class="form-control" name="startDate" id="datepicker"  /> 
                </div> 
                
                
                <div class="form-group">
                     <label class="label1">End Date: </label><span class="style1">*</span>
                            <form:input type="text" path="endDate"  class="form-control" name="endDate" id="datepicker1"  /> 
                </div> 
