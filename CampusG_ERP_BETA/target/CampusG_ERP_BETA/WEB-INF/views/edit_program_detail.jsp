...
<br/>
<div class="row">
      <form:form method="POST" commandName="program" id="validate"
						action="${pageContext.request.contextPath}/Update_Program_view">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="programId" name="programId" value="${p.programId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="programName" name="programName" value="${p.programName}" type="text" class="form-control"  />
									  
								</div>
								
								<div class="form-group">
									<label class="label1">Course Level </label>
									<form:input path="courselevelNamefk" name="courselevelNamefk" value="${p.courselevelNamefk}" type="text" class="form-control"  />
