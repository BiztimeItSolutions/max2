...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Edit Mode of Payment Details</b></h6>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
      <form:form method="POST" commandName="payment" id="validate"
						action="${pageContext.request.contextPath}/Update_Paymentmode_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Mode ID</label>
									<form:input path="paymentmodeId" name="paymentmodeId" value="${p.paymentmodeId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									<label class="label1">Payment Mode</label>
									<form:input path="paymentMode" name="paymentMode" value="${p.paymentMode}" type="text" class="form-control"  />
