    ...
    <div id="page-wrapper">
		 ...
		 <div class="row">
            ...
            <br>
              ...
              <form:form method="POST" commandName="user_role" id=""
						action="${pageContext.request.contextPath}/User_role">
				  ...
				  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label class="label1">User Role: </label><span class="style1"></span>
						<form:select path="user_role" class="form-control" name="user" id="user_role">
