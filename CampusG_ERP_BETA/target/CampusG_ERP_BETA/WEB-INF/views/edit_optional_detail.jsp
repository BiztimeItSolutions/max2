...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Edit Optional Subject Details</b></h6>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<br/>
<div class="row">
      <form:form method="POST" commandName="optional" id="validate"
						action="${pageContext.request.contextPath}/Update_Optional_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Optional Subject</label>
									<form:input path="optionalId" name="optionalId" value="${p.optionalId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="optionalName" name="optionalName" value="${p.optionalName}" type="text" class="form-control"  />
