...
<br/>
<div class="row">
     <form:form method="POST" commandName="semsubmap" id="validate"
						action="${pageContext.request.contextPath}/savesemsubmapDetails">
	   <div class="row">			
			...
			<div class="col-lg-5">
                ...
                <div class="form-group">
                     <label class="label1">Semester Name: </label><span class="style1">*</span>
                            <form:select path="semesterId" class="form-control" name="semsterId" id="semesterId">
