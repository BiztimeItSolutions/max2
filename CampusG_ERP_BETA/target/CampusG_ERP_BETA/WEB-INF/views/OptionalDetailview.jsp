...
<div id="page-wrapper">
	...
	<h4>View Optional subject Details
	<p align="right"><a href="masteroptionalpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.optionalId}"/></td> 
                                            <td><c:out value="${c.optionalName}"/>
                                           
                                            
                                        <td>    
                                               <a href="toviewcompleteoptionalDetail?optionalId=${c.optionalId}">View</a> / 
										    	<a href="toeditoptionalDetail?optionalId=${c.optionalId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeleteoptionalDetail?optionalId=${c.optionalId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
