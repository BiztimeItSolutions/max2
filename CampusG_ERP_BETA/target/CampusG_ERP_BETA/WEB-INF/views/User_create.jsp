    ...
    <div id="page-wrapper">
		 ...
		 <div class="row">
            ...
            <br>
              ...
              <form:form method="POST" commandName="user1" id=""
						action="${pageContext.request.contextPath}/User_create">
			 ...
			 <div class="row">
                 ...
                 <div class="form-group">
				  ...
				  <div class="form-group">
                    <label class="label1">User: </label><span class="style1"></span>
						<form:select path="user_name" class="form-control" name="user" id="user">
							<form:option value="none" label="Select User"/>
                        </form:select>
                  </div>
				  <div class="form-group">
                    <label class="label1">Role: </label><span class="style1"></span>
						<form:select path="role" class="form-control" name="role_type" id="role">
				...
				<div class="form-group">
                    <label class="label1">Module: </label><span class="style1"></span>
						<form:select path="module" class="form-control" name="module" id="module">
							<form:option value="none" label="Select Module"/>
                        </form:select>
                  </div>

				<%--   <div class="form-group">
                    <label class="label1">Permission: </label><span class="style1"></span>
						<form:select path="permission_read" class="form-control" name="course_name" id="course_name">
           ...
           <div class="form-group">
				<label class="label1">Permission</label><span class="style1"></span>
                  ...
                  <div class="form-control-permission">
                     <!--   <label class="label1">Permission</label> -->
                       <label class="checkbox-inline">
                       		<form:checkbox path="permission_read" />Read
                       </label>&nbsp;&nbsp;
                       <label class="checkbox-inline">
                       		<form:checkbox path="permission_create" />Create
                       </label>&nbsp;&nbsp;
                       <label class="checkbox-inline">
                       		<form:checkbox path="permission_edit" />Edit
                       </label>
                       <label class="checkbox-inline">
                       		<form:checkbox path="permission_delete" />Ddelete
                       </label>
                  </div>
            </div>
