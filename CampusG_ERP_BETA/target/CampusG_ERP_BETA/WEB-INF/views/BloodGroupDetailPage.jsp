...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Enter Blood Group Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
     <form:form method="POST" commandName="blood" id="validate"
						action="${pageContext.request.contextPath}/saveBloodDetail">
	   <div class="row">			
			...
			<div class="col-lg-5">
                ...
                <div class="form-group">
                     <label class="label1">Blood Group : </label><span class="style1">*</span>
                            <form:input type="text" path="groupName"  class="form-control" name="groupName"   /> 
                </div> 
