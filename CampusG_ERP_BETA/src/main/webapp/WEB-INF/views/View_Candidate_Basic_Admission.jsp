			...
			<div class="row">
                <div class="col-lg-12">
					...
					<div class="panel panel-default">
                        ...
                        <%-- <form:form method="POST" commandName="viewAll" id=""> --%>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <td>     
										    	<a href="view_candidate_detail_admission?candidate_id=${c.candidate_id}">View</a>
										</td>
										<td><c:out value="${c.admission_status}"/></td>
										
										<%-- <c:forEach items="${p}" var="c">
										<td><c:out value="${c.candidateid}"/></td>
										</c:forEach>
										 --%>
										
										
										<%--  <td>     
										    	<a href="view_candidate_account_detail?candidate_id=${c.candidateid}">View Account</a> 
