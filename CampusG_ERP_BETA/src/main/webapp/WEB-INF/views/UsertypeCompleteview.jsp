...
<br/>
<div class="row">
      <form:form method="POST" commandName="usertype" 
						action="${pageContext.request.contextPath}/viewusertypeback">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="usertypeId" name="usertypeId" value="${p.usertypeId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									...
									<form:input path="usertypeName" name="usertypeName" value="${p.usertypeName}" type="text" class="form-control"  readonly="true"/>
