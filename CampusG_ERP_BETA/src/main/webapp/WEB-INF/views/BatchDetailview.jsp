...
<div id="page-wrapper">
	...
	<h4>View Batch Details
	<p align="right"><a href="masterbatchpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.batchId}"/></td> 
                                            <td><c:out value="${c.batchName}"/>
                                          <td><c:out value="${c.courseCodefk}"/></td>
                                            
                                             
                                            
                                        <td>    
                                               <a href="toviewcompletebatchDetail?batchId=${c.batchId}">View</a> / 
										     <a href="toeditbatchDetail?batchId=${c.batchId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    		<a href="todeletebatchDetail?batchId=${c.batchId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
