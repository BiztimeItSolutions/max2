...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Edit Permission  Details</b></h6>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<br/>
<div class="row">
      <form:form method="POST" commandName="permission" id="validate"
						action="${pageContext.request.contextPath}/Update_Permission_view">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="permissionId" name="permissionId" value="${p.permissionId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="permissionName" name="permissionName" value="${p.permissionName}" type="text" class="form-control"  />
