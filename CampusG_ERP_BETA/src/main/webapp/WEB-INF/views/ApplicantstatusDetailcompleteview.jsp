...
<br/>
<div class="row">
      <form:form method="POST" commandName="status" 
						action="${pageContext.request.contextPath}/viewstatusback">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="statusId" name="statusId" value="${p.statusId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									...
									<form:input path="statusName" name="statusName" value="${p.statusName}" type="text" class="form-control" readonly="true" />
