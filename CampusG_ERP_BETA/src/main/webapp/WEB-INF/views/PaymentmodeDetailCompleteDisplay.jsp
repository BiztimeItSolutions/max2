...
<div class="row">
      <form:form method="POST" commandName="payment" 
						action="${pageContext.request.contextPath}/viewpaymentmodeback">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Paymentmode ID</label>
									<form:input path="paymentmodeId" name="paymentmodeId" value="${p.paymentmodeId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									<label class="label1">Mode of payment</label>
									<form:input path="paymentMode" name="paymentMode" value="${p.paymentMode}" type="text" class="form-control" readonly="true" />
