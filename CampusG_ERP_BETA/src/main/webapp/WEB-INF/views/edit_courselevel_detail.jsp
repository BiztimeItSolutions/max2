...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Edit Course Level Details</b></h6>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
      <form:form method="POST" commandName="courselevel" id="validate"
						action="${pageContext.request.contextPath}/Update_Courselevel_view">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="courselevelId" name="courselevelId" value="${p.courselevelId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="courselevelName" name="courselevelName" value="${p.courselevelName}" type="text" class="form-control"  />
