...
<br/>
<div class="row">
      <form:form method="POST" commandName="academic" 
						action="${pageContext.request.contextPath}/viewacademicback">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Academic year ID</label>
									<form:input path="academicyearId" name="academicyearId" value="${p.academicyearId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									...
									<form:input path="academicYear" name="academicYear" value="${p.academicYear}" type="text" class="form-control" readonly="true" />
