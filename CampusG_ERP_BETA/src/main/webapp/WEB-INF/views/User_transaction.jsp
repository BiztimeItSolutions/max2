...
<!--Start of Main page-->
    <div id="page-wrapper">
		 ...
		 <div class="row">
            ...
            <br>
              ...
              <form:form method="POST" commandName="user_transaction" id=""
						action="${pageContext.request.contextPath}/User_transaction">
                 ...
                 <div class="form-group">
				  ...
				  <div class="form-group">
                    <label class="label1">User Name: </label><span class="style1"></span>
						<form:select path="user_name" class="form-control" name="user" id="user_name" onChange="searchOnUser()">
                   ...
                   <div class="form-group">
                    <label class="label1">Department: </label><span class="style1"></span>
						<form:select path="user_department" class="form-control" name="user_department" 
						id="user_department">
             ...
             <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                          ...
                          <tr class="odd gradeX">
                         <td align="center">
                         <form:checkbox path="user_module"  value="${d.module_name}"/>
                   </td>
                          <td><c:out value="${d.module_name}"/></td>
                          </tr> 
                                        </c:forEach>
                                        </tbody>
                                </table>
   ...
   <!-- Core Scripts - Include with every page -->
	...
	<script src="<c:url value="/resources/js/User_transaction.js" />"></script>
