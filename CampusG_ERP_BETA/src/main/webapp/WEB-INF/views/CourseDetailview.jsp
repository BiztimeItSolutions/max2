...
<div id="page-wrapper">
	...
	<p align="right"><a href="mastercoursepage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                          ...
                                          <td><c:out value="${c.programNamefk}"/></td>
                                            
                                             
                                            
                                        <td>    
                                               <a href="toviewcompletecourseDetail?courseId=${c.courseId}">View</a> / 
										     <a href="toeditcourseDetail?courseId=${c.courseId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    		<a href="todeletecourseDetail?courseId=${c.courseId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
