...
<div id="page-wrapper">
	...
	<h4>View Academic Year Details
	<p align="right"><a href="masteracademicpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.academicyearId}"/></td>
                                            <td><c:out value="${c.academicYear}"/>
                                           
                                            
                                        <td>    
                                               <a href="toviewcompleteacademicDetail?academicyearId=${c.academicyearId}">View</a> / 
										    	 <a href="toeditacademicDetail?academicyearId=${c.academicyearId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeleteacademicDetail?academicyearId=${c.academicyearId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
