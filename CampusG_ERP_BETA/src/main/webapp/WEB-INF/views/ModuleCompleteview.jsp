...
<br/>
<div class="row">
      <form:form method="POST" commandName="module" 
						action="${pageContext.request.contextPath}/viewmoduleback">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Module ID</label>
									<form:input path="moduleId" name="moduleId" value="${p.moduleId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									<label class="label1">Module Name</label>
									<form:input path="moduleName" name="moduleName" value="${p.moduleName}" type="text" class="form-control" readonly="true" />
                	                     ...
                	                     <form:input path="collegeNamefk" value="${p.collegeNamefk}" name="collegeNamefk" type="text" class="form-control" readonly="true"/>  
		    	                        </div>
								
								<div class="form-group">
								<label class="label1">Parent module ID</label>
									<form:input path="parentId" name="parentId" value="${p.parentId}" type="text" class="form-control" readonly="true"
										 />
								</div>
