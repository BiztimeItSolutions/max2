...
<br/>
<div class="row">
      <form:form method="POST" commandName="document" id="validate"
						action="${pageContext.request.contextPath}/Update_Document_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Document ID</label>
									<form:input path="documentId" name="documentId" value="${p.documentId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									<label class="label1">Document Name</label>
									<form:input path="documentName" name="documentName" value="${p.documentName}" type="text" class="form-control"  />
