...
<br/>
<div class="row">
      <form:form method="POST" commandName="program" 
						action="${pageContext.request.contextPath}/viewprogramback">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Program ID</label>
									<form:input path="programId" name="programId" value="${p.programId}" type="text" class="form-control"  readonly="true"/>
								...
								<div class="form-group">
									...
									<form:input path="programName" name="programName" value="${p.programName}" type="text" class="form-control" readonly="true" />
									  
								</div>
								
								<div class="form-group">
									<label class="label1">Course Level Name</label>
									<form:input path="courselevelNamefk" name="courselevelNamefk" value="${p.courselevelNamefk}" type="text" class="form-control"  readonly="true"/>
