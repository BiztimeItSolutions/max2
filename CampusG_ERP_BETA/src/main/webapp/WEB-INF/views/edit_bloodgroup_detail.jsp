...
<br/>
<div class="row">
      <form:form method="POST" commandName="blood" id="validate"
						action="${pageContext.request.contextPath}/Update_Bloodgroup_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Blood Group ID</label>
									<form:input path="groupId" name="groupId" value="${p.groupId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="groupName" name="groupName" value="${p.groupName}" type="text" class="form-control"  />
