...
<br/>
<div class="row">
      <form:form method="POST" commandName="leave" id="validate"
						action="${pageContext.request.contextPath}/Update_Leave_view">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="leaveTypeId" name="leaveTypeId" value="${p.leaveTypeId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="leaveName" name="leaveName" value="${p.leaveName}" type="text" class="form-control"  />
                	                     ...
                	                     <form:input path="leaveCode" value="${p.leaveCode}" name="leaveCode" type="text" class="form-control" />  
		    	                        </div>
								
								<div class="form-group">
								<label class="label1">Leave Count </label>
									<form:input path="leaveCount" name="leaveCount" value="${p.leaveCount}" type="text" class="form-control"
										 />
								</div>
								...
								<div class="form-group">
								   ...
								   <form:input path="resetDate" value="${p.resetDate}" name="resetDate" type="text" class="form-control"  />
								</div>
								<div class="form-group">
									<label class="label1"> Enable Leave</label>
									<%-- <form:input path="gender" type="text" class="form-control" name="gender" /> --%>
									<form:input path="enableLeave" value="${p.enableLeave}" name="enableLeave" type="text" class="form-control"  />
								</div>
								...
								<div class="form-group">
									...
									<%-- <form:input path="gender" type="text" class="form-control" name="gender" /> --%>
									<form:input path="status" value="${p.status}" name="status" type="text" class="form-control"  />
								</div>
