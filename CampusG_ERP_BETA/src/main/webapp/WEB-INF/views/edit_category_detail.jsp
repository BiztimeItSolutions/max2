...
<br/>
<div class="row">
      <form:form method="POST" commandName="category" id="validate"
						action="${pageContext.request.contextPath}/Update_Category_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Category ID</label>
									<form:input path="categoryId" name="categoryId" value="${p.categoryId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									<label class="label1">Category Name</label>
									<form:input path="categoryName" name="categoryName" value="${p.categoryName}" type="text" class="form-control"  />
