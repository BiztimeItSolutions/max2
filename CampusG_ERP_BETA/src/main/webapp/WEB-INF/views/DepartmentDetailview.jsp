...
<div id="page-wrapper">
	...
	<h4>View Department Details
	<p align="right"><a href="masterdepartmentpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.departmentId}"/></td> 
                                            <td><c:out value="${c.departmentName}"/>
                                         
                                            
                                             
                                            
                                        <td>    
                                               <a href="toviewcompletedepartmentDetail?departmentId=${c.departmentId}">View</a> / 
										       <a href="toeditdepartmentDetail?departmentId=${c.departmentId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										        <a href="todeletedepartmentDetail?departmentId=${c.departmentId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a> 
