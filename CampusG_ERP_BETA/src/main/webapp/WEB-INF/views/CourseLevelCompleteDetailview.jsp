...
<div class="row">
	 <div class="col-lg-6">
		  <h4>View Course level Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<br/>
<div class="row">
      <form:form method="POST" commandName="courselevel" 
						action="${pageContext.request.contextPath}/viewcourselevelback">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Course Level ID</label>
									<form:input path="courselevelId" name="courselevelId" value="${p.courselevelId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									...
									<form:input path="courselevelId" name="courselevelId" value="${p.courselevelName}" type="text" class="form-control" readonly="true" />
