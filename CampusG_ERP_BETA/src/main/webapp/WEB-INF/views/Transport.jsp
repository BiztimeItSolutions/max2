...
<!--Start of Main page-->
    <div id="page-wrapper">
		 ...
		 <div class="row">
                <div class="col-lg-12">
				    <h4 class="page-header">Admission | <span class="style2">Transport</span></h4> 
				</div><!-- /.col-lg-12 -->
         </div><!-- /.row -->
...
<p>Hi... Well come</p>
<c:choose>
	<c:when test="${ShowForm eq 'manager'}">
		<p>Transport Manager</p>
	</c:when>
	
	<c:when test="${ShowForm eq 'view'}">
		 <p>Transport View</p>
	</c:when>
	
	<c:when test="${ShowForm eq 'delete'}">
		 <p>Transport Delete</p>
	</c:when>
