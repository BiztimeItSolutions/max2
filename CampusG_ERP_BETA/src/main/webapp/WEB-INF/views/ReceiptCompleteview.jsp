...
<div class="row">
      <form:form method="POST" commandName="receipt" 
						action="${pageContext.request.contextPath}/viewreceiptback">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="receiptId" name="receiptId" value="${p.receiptId}" type="text" class="form-control" readonly="true" />
								...
								<div class="form-group">
									...
									<form:input path="receiptName" name="receiptName" value="${p.receiptName}" type="text" class="form-control" readonly="true" />
