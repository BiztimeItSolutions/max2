...
<br/>
<div class="row">
     <form:form method="POST" commandName="course" id=""
						action="${pageContext.request.contextPath}/saveCourseDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Category Name: </label><span class="style1">*</span>
                            <form:input type="text" path="courseName"  class="form-control" name="courseName"   /> 
                </div> 
                
                <div class="form-group">
                     <label class="label1">Program ID: </label><span class="style1">*</span>
                            <form:input type="text" path="programId"  class="form-control" name="programId"   /> 
                </div> 
