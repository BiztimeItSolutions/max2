...
<br/>
<div class="row">
      <form:form method="POST" commandName="role" id="validate"
						action="${pageContext.request.contextPath}/Update_Role_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Role ID</label>
									<form:input path="roleId" name="roleId" value="${p.roleId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="roleName" name="roleName" value="${p.roleName}" type="text" class="form-control"  />
