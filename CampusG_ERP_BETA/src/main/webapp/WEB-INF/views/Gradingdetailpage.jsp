...
<br/>
<div class="row">
     <form:form method="POST" commandName="grading" id="validate"
						action="${pageContext.request.contextPath}/saveGradingDetail">
	   <div class="row">			
			...
			<div class="col-lg-5">
                ...
                <div class="form-group">
                     <label class="label1">Grading System: </label><span class="style1">*</span>
                            <form:input type="text" path="grading"  class="form-control" name="grading"   /> 
                </div> 
