...
<div class="row">
      <form:form method="POST" commandName="module" id="validate"
						action="${pageContext.request.contextPath}/Update_module_view">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="moduleId" name="moduleId" value="${p.moduleId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="moduleName" name="moduleName" value="${p.moduleName}" type="text" class="form-control"  />
                	                     ...
                	                     <form:input path="collegeNamefk" value="${p.collegeNamefk}" name="collegeNamefk" type="text" class="form-control" />  
		    	                        </div>
								
								<div class="form-group">
								<label class="label1">Parent Module</label>
									<form:input path="parentId" name="parentId" value="${p.parentId}" type="text" class="form-control"
										 />
								</div>
