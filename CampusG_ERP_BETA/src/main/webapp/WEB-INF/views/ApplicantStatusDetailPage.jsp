...
<div class="row">
     <form:form method="POST" commandName="status" id="validate"
						action="${pageContext.request.contextPath}/saveStatusDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Status Name: </label><span class="style1">*</span>
                            <form:input type="text" path="statusName"  class="form-control" name="categoryName"   /> 
                </div> 
