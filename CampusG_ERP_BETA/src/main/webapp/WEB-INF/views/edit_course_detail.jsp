...
<div class="row">
      <form:form method="POST" commandName="course" id="validate"
						action="${pageContext.request.contextPath}/Update_Course_view">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="courseId" name="courseId" value="${p.courseId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="courseName" name="courseName" value="${p.courseName}" type="text" class="form-control"  />
                	                     ...
                	                     <form:input path="programNamefk" value="${p.programNamefk}" name="programNamefk" type="text" class="form-control" />  
		    	                        </div>
