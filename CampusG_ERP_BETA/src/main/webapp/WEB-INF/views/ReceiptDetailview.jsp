...
<div id="page-wrapper">
	...
	<h4>View Receipt Details
	<p align="right"><a href="masterreceiptpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.receiptId}"/></td> 
                                            <td><c:out value="${c.receiptName}"/>
                                          
                                             
                                            
                                        <td>    
                                               <a href="toviewcompletereceiptDetail?receiptId=${c.receiptId}">View</a> / 
										    	<a href="toeditreceiptDetail?receiptId=${c.receiptId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeletereceiptDetail?receiptId=${c.receiptId}" class="deleteconfirmation" ><img src="resources/images/delete16.png" width="16" height="16"></a>
