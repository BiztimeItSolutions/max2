...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Enter Document Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
     <form:form method="POST" commandName="document" id="validate"
						action="${pageContext.request.contextPath}/saveDocumentDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Document Name: </label><span class="style1">*</span>
                            <form:input type="text" path="documentName"  class="form-control" name="documentName"   /> 
                </div> 
