...
<div id="page-wrapper">
	...
	<h4>View Permission Details
	<p align="right"><a href="masterpermissionpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.permissionId}"/></td> 
                                            <td><c:out value="${c.permissionName}"/>
                                     
                                            
                                             
                                            
                                        <td>    
                                               <a href="toviewcompletepermissionDetail?permissionId=${c.permissionId}">View</a> / 
										     <a href="toeditpermissionDetail?permissionId=${c.permissionId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    		<a href="todeletepermissionDetail?permissionId=${c.permissionId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
