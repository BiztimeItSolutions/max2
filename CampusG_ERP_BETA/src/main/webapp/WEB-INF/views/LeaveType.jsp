...
<div class="row">
     <form:form method="POST" commandName="leave" id="validate"
						action="${pageContext.request.contextPath}/saveLeaveDetail">
	   <div class="row">			
			...
			<div class="col-lg-5">
                ...
                <div class="form-group">
                     <label class="label1">Leave Name: </label><span class="style1">*</span>
                            <form:input type="text" path="leaveName"  class="form-control" name="leaveName"   /> 
                </div> 
					
					 <div class="form-group">
                     <label class="label1">Leave Code: </label><span class="style1">*</span>
                            <form:input type="text" path="leaveCode"  class="form-control" name="leaveCode"   /> 
                </div> 
                     ...
                     <label class="label1">Leave Count: </label><span class="style1">*</span>
                            <form:input type="text" path="leaveCount"  class="form-control" name="leaveCount"   /> 
      </div>
					<div class="form-group">
                     <label class="label1">Enable Date: </label><span class="style1">*</span>
                            <form:input type="text" path="enableLeave"  class="form-control" name="enableLeave"  id="datepicker" /> 
                </div> 
					
					
					
					 <div class="form-group">
                     <label class="label1">Reset Date:</label><span class="style1">*</span>
                            <form:input type="date" path="resetDate"  class="form-control" name="resetDate"  id="datepicker" /> 
                </div> 
                ...
                <div class="form-group">
                     <label class="label1">Status</label><span class="style1">*</span>
                            <form:input type="text" path="status"  class="form-control" name="status" rows="5" id="" /></textarea> 
                </div> 
					 <div class="form-group">
...
<!-- Core Scripts - Include with every page -->
	...
	<script type="text/javascript">
	 var now = new Date();
      document.getElementById("fname").value=now.getFullYear()+'-'+0+(now.getMonth()+1)+'-'++now.getDate();
      </script>
