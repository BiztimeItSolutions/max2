...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Enter User Type Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
     <form:form method="POST" commandName="usertype" id="validate"
						action="${pageContext.request.contextPath}/saveUsertypeDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">User Type Name: </label><span class="style1">*</span>
                            <form:input type="text" path="usertypeName"  class="form-control" name="usertypeName"   /> 
                </div> 
