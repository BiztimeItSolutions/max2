...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Enter Category Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
     <form:form method="POST" commandName="category" id="validate"
						action="${pageContext.request.contextPath}/saveCategoryDetail">
	   <div class="row">			
			...
			<div class="col-lg-5">
                ...
                <div class="form-group">
                     <label class="label1">Category Name: </label><span class="style1">*</span>
                            <form:input type="text" path="categoryName"  class="form-control" name="categoryName"   /> 
                </div> 
