...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Enter Academic Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
     <form:form method="POST" commandName="academic" id="validate"
						action="${pageContext.request.contextPath}/saveAcademicDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Academic Year  : </label><span class="style1">*</span>
                            <form:input type="text" path="academicYear"  class="form-control" name="academicYear" /> 
                </div> 
