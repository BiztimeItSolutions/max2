...
<div class="row">
	 <div class="col-lg-6">
		  <h4>View Department Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
      <form:form method="POST" commandName="department" 
						action="${pageContext.request.contextPath}/viewdepartmentback">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="departmentId" name="departmentId" value="${p.departmentId}" type="text" class="form-control"  readonly="true"/>
								...
								<div class="form-group">
									...
									<form:input path="departmentName" name="departmentName" value="${p.departmentName}" type="text" class="form-control"  readonly="true"/>
