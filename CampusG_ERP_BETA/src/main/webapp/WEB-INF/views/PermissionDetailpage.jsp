...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Enter Permission Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
     <form:form method="POST" commandName="permission" id="validate"
						action="${pageContext.request.contextPath}/savePermissionDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Permission Name: </label><span class="style1">*</span>
                            <form:input type="text" path="permissionName"  class="form-control" name="permissionName"   /> 
                </div> 
