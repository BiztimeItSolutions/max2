...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Enter Department Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
     <form:form method="POST" commandName="department" id="validate"
						action="${pageContext.request.contextPath}/saveDepartmentDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Department Name: </label><span class="style1">*</span>
                            <form:input type="text" path="departmentName"  class="form-control" name="departmentName"   /> 
                </div> 
