...
<div id="page-wrapper">
	...
	<p align="right"><a href="mastercategorypage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.categoryId}"/></td> 
                                            <td><c:out value="${c.categoryName}"/>
                                           
                                            
                                        <td>    
                                               <a href="toviewcompletecategoryDetail?categoryId=${c.categoryId}">View</a> / 
										     <a href="toeditcategoryDetail?categoryId=${c.categoryId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeletecategoryDetail?categoryId=${c.categoryId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a> 
