...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Edit Department Details</b></h6>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<br/>
<div class="row">
      <form:form method="POST" commandName="department" id="validate"
						action="${pageContext.request.contextPath}/Update_Department_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Department ID</label>
									<form:input path="departmentId" name="departmentId" value="${p.departmentId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									<label class="label1">Department Name</label>
									<form:input path="departmentName" name="departmentName" value="${p.departmentName}" type="text" class="form-control"  />
