...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Edit user Type Details</b></h6>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<br/>
<div class="row">
      <form:form method="POST" commandName="usertype" id="validate"
						action="${pageContext.request.contextPath}/Update_Usertype_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">User Type ID</label>
									<form:input path="usertypeId" name="usertypeId" value="${p.usertypeId}" type="text" class="form-control"  />
									  
								</div>
							
                             	
                             	<div class="form-group">
									<label class="label1">User Type Name</label>
									<form:input path="usertypeName" name="usertypeName" value="${p.usertypeName}" type="text" class="form-control"  />
