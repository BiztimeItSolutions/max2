...
<div class="row">
	 <div class="col-lg-6">
		  <h4>View Optional Subject Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<br/>
<div class="row">
      <form:form method="POST" commandName="optional" 
						action="${pageContext.request.contextPath}/viewoptionalback">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Optional Subject ID</label>
									<form:input path="optionalId" name="optionalId" value="${p.optionalId}" type="text" class="form-control"  readonly="true"/>
								...
								<div class="form-group">
									<label class="label1">Optional Subject Name</label>
									<form:input path="optionalName" name="optionalName" value="${p.optionalName}" type="text" class="form-control"  readonly="true"/>
