...
<div id="page-wrapper">
	...
	<h4>View Semester Details
	<p align="right"><a href="mastersemester"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.semesterId}"/></td> 
                                            <td><c:out value="${c.semesterName}"/>
                                            
                                           
                                            
                                         <td>    
                                               <a href="toviewcompletesemesterDetail?semesterId=${c.semesterId}">View</a> / 
										    	<a href="toeditsemesterDetail?semesterId=${c.semesterId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeletesemesterDetail?semesterId=${c.semesterId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a> 
