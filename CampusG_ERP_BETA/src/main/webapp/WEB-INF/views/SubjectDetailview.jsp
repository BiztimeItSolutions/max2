...
<div id="page-wrapper">
	...
	<h4>View Subject Details
	<p align="right"><a href="mastersubjectpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.subjectId}"/></td> 
                                           <td><c:out value="${c.subjectCode}"/></td> 
                                            <td><c:out value="${c.subjectName}"/>
                                          
                                             
                                            
                                        <td>    
                                               <a href="toviewcompletesubjectDetail?subjectId=${c.subjectId}">View</a> / 
										    	<a href="toeditsubjectDetail?subjectId=${c.subjectId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeletesubjectDetail?subjectId=${c.subjectId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
