...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Enter Semester Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
     <form:form method="POST" commandName="semester" id="validate"
						action="${pageContext.request.contextPath}/saveSemesterDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Semester Number: </label><span class="style1">*</span>
                            <form:input type="text" path="semesterName"  class="form-control" name="semesterName"   /> 
                </div> 
