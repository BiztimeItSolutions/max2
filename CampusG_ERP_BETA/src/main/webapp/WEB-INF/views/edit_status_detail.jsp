...
<br/>
<div class="row">
      <form:form method="POST" commandName="status" id="validate"
						action="${pageContext.request.contextPath}/Update_Status_view">

                        <div class="col-lg-5">
                             	
                             	
								<div class="form-group">
									<label class="label1">Status ID</label>
									<form:input path="statusId" name="statusId" value="${p.statusId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									<label class="label1">Status Name</label>
									<form:input path="statusName" name="statusName" value="${p.statusName}" type="text" class="form-control"  />
