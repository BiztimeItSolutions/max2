...
<!--Start of Main page-->
    <div id="page-wrapper">
		 ...
		 <div class="row">
          ...
          <form:form method="POST" commandName="urm" id="ans"
						action="${pageContext.request.contextPath}/privilage">
                ...
                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                   ...
                   <c:forEach items="${p}" var="d">
                	...
                	<%--  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><form:checkbox path="privilege" name="checkApprove" value="Admission_admin"/></td>
                                            <td>Admission admin </td>
                                        </tr>
                                        <tr>
                                            <td><form:checkbox path="privilege" name="checkApprove" value="Office_admin"/></td>
                                            <td>Office admin</td>
                                        </tr>
                                        <tr>
                                            <td><form:checkbox path="privilege" name="checkApprove" value="Account_admin"/></td>
                                            <td>Account admin</td>
                                        </tr>
                                    </tbody>
                      </table>
			     ...
			     <div class="col-lg-4">
                	 ...
                	 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><form:checkbox path="privilege"  value="Transport_manage"/></td>
                                            <td>Transport Manage</td>
                                        </tr>
                                        <tr>
                                            <td><form:checkbox path="privilege"  value="Transport_view"/></td>
                                            <td>Transport View</td>
                                        </tr>
                                        <tr>
                                            <td><form:checkbox path="privilege"  value="Transport_delete"/></td>
...
<%-- <script src="<c:url value="/resources/js/Create_user.js" />"></script> --%>  
	<script src="<c:url value="/resources/js/user_role_module.js" />"></script>
...
alert("ready");
	...
	alert("ready..1");
		var boxes=$('input[name=checkApprove]');
		$(boxes).each(function(){
