...
<div id="page-wrapper">
	...
	<h4>View Status Details
	<p align="right"><a href="masterstatuspage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.statusId}"/></td>
                                            <td><c:out value="${c.statusName}"/>
                                           
                                            
                                        <td>    
                                               <a href="toviewcompletestatusDetail?statusId=${c.statusId}">View</a> / 
										    	 <a href="toeditstatusDetail?statusId=${c.statusId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeletestatusDetail?statusId=${c.statusId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
