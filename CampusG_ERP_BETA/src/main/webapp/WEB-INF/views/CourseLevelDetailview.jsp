...
<div id="page-wrapper">
	...
	<h4>View Course Level Details
	<p align="right"><a href="mastercourselevelpage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.courselevelId}"/></td> 
                                            <td><c:out value="${c.courselevelName}"/>
                                          
                                            
                                             
                                            
                                        <td>    
                                         <a href="toviewcompletecourselevelDetail?courselevelId=${c.courselevelId}">View</a> / 
										 <a href="toeditcourselevelDetail?courselevelId=${c.courselevelId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										  <a href="todeletecourselevelDetail?courselevelId=${c.courselevelId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a> 
