...
<div class="row">
      <form:form method="POST" commandName="document" 
						action="${pageContext.request.contextPath}/viewdocumentback">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="documentId" name="documentId" value="${p.documentId}" type="text" class="form-control"  readonly="true"/>
								...
								<div class="form-group">
									<label class="label1">Role Name</label>
									<form:input path="documentName" name="documentName" value="${p.documentName}" type="text" class="form-control" readonly="true" />
