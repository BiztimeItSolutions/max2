...
<div id="page-wrapper">
	...
	<h4>View Leave Details
	<p align="right"><a href="masterleavetypepage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.leaveTypeId}"/></td> 
                                            <td><c:out value="${c.leaveName}"/>
                                           <%--  <td><c:out value="${c.collegeCode}"/></td>
                                            <td><c:out value="${c.universityId}"/></td>
                                           <td><c:out value="${c.collegeAddress}"/></td> --%>
                                            <td><c:out value="${c.leaveCode}"/></td>
                                            <td><c:out value="${c.leaveCount}"/></td>
                                             <td><c:out value="${c.resetDate}"/></td>
                                            <td><c:out value="${c.enableLeave}"/></td>
                                            <td><c:out value="${c.status}"/></td>
                                             
                                            
                                        <td>    
                                               <a href="toviewcompleteleaveDetail?leaveTypeId=${c.leaveTypeId}">View</a> / 
										    	<a href="toeditleaveDetail?leaveTypeId=${c.leaveTypeId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeleteleaveDetail?leaveTypeId=${c.leaveTypeId}" class="deleteconfirmation" ><img src="resources/images/delete16.png" width="16" height="16"></a>
