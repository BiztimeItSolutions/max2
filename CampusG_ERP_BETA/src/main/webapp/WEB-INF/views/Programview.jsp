...
<div id="page-wrapper">
	...
	<h4>View Program Details
	<p align="right"><a href="masterprogrampage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.programId}"/></td> 
                                            <td><c:out value="${c.programName}"/>
                                            <td><c:out value="${c.courselevelNamefk}"/>
                                           
                                            
                                         <td>    
                                               <a href="toviewcompleteprogramDetail?programId=${c.programId}">View</a> / 
										    	<a href="toeditprogramDetail?programId=${c.programId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeleteprogramDetail?programId=${c.programId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a> 
