...
<div class="row">
     <form:form method="POST" commandName="receipt" id="validate"
						action="${pageContext.request.contextPath}/saveReceiptDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Receipt Name: </label><span class="style1">*</span>
                            <form:input type="text" path="receiptName"  class="form-control" name="receiptName" id="receiptName"  /> 
                </div> 
