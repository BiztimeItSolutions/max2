...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Enter Course Level Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<br/>
<div class="row">
     <form:form method="POST" commandName="courselevel" id="validate"
						action="${pageContext.request.contextPath}/saveCourselevelDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Course Level Name: </label><span class="style1">*</span>
                            <form:input type="text" path="courselevelName"  class="form-control" name="courselevelName"   /> 
                </div> 
                     ...
                     <label hidden class="label1">Modified On: </label><span class="style1"></span>
                            <form:input type="hidden" path="modifiedOn"  class="form-control" name="modifiedOn"  id="fname"  /> 
                </div> 
                <div>
...
<!-- Core Scripts - Include with every page -->
	...
	<script type="text/javascript">
	 var now = new Date();
      document.getElementById("fname").value=now.getFullYear()+'-'+(now.getMonth()+1)+'-'+now.getDate();
      </script>
