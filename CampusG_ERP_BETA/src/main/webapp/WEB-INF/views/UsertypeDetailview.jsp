...
<div id="page-wrapper">
	...
	<h4>View User type Details
	<p align="right"><a href="masterusertypepage"><img src="resources/images/add.png" width="16" height="16"><strong>Add</strong></a></p></h4> 
			<div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   <tr>
                                    ...
                                    <c:forEach items="${p}" var="c">
                                        ...
                                        <tr class="odd gradeX">
                                           <td><c:out value="${c.usertypeId}"/></td> 
                                           
                                            <td><c:out value="${c.usertypeName}"/>
                                          
                                             
                                            
                                        <td>    
                                               <a href="toviewcompleteusertypeDetail?usertypeId=${c.usertypeId}">View</a> / 
										    	<a href="toeditusertypeDetail?usertypeId=${c.usertypeId}"><img src="resources/images/edit.png" width="16" height="16"></a> /
										    	<a href="todeleteusertypeDetail?usertypeId=${c.usertypeId}" class="deleteconfirmation"><img src="resources/images/delete16.png" width="16" height="16"></a>
