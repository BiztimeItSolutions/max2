...
<br/>
<div class="row">
      <form:form method="POST" commandName="batch" id="validate"
						action="${pageContext.request.contextPath}/Update_Batch_view">
                        ...
                        <div class="col-lg-5">
								...
								<div class="form-group">
									...
									<form:input path="batchId" name="batchId" value="${p.batchId}" type="text" class="form-control"  />
								...
								<div class="form-group">
									...
									<form:input path="batchName" name="batchName" value="${p.batchName}" type="text" class="form-control"  />
                	                     ...
                	                     <form:input path="courseCodefk" value="${p.courseCodefk}" name="courseCodefk" type="text" class="form-control" />  
		    	                        </div>
