...
<div class="row">
     <form:form method="POST" commandName="program" id="validate"
						action="${pageContext.request.contextPath}/saveProgramDetail">
	   <div class="row">			
			...
			<div class="col-lg-5">
                ...
                <div class="form-group">
                     <label class="label1">Program Name: </label><span class="style1">*</span>
                            <form:input type="text" path="programName"  class="form-control" name="programName"   /> 
                </div> 
                
                <div class="form-group">
                     <label class="label1">Course Level : </label><span class="style1">*</span>
                  
               <form:select path="courselevelNamefk" class="form-control" name="courselevelNamefk" id="courselevelNamefk">
							      <form:option value="" label="Select Course level "/>
                            </form:select>
