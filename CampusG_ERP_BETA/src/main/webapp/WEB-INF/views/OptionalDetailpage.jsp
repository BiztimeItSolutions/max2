...
<div class="row">
	 <div class="col-lg-6">
		  <h4>Enter Optional Subject Details</b></h4>
	</div><!--col 6 -->
</div><!--row -->
	  <br />
<div class="row">
...
<div class="row">
     <form:form method="POST" commandName="optional" id="validate"
						action="${pageContext.request.contextPath}/saveOptionalDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Optional Name: </label><span class="style1">*</span>
                            <form:input type="text" path="optionalName"  class="form-control" name="optionalName"   /> 
                </div> 
