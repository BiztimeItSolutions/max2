...
String settings=null, emp_leave_mgnt=null, emp_search=null, emp_mgnt=null, create_payslip=null, emp_payslip=null;    
   ...
   String sql1 = "SELECT menu_name from masterdatatable.menu where menu_id = 1";
   ...
   String sql2 = "SELECT menu_name from masterdatatable.menu where menu_id = 2";
   ...
   String sql3 = "SELECT menu_name from masterdatatable.menu where menu_id = 3";
   ...
   String sql4 = "SELECT menu_name from masterdatatable.menu where menu_id = 4";
   ...
   String sql5 = "SELECT menu_name from masterdatatable.menu where parent = 1 and menu_name like 'User' ";
   ...
   String sql6 = "SELECT menu_name from masterdatatable.menu where parent = 1 and menu_name like 'Configuration' ";
   ...
   String sql7 = "SELECT menu_name from masterdatatable.menu where parent = 1 and menu_name like 'Finance' ";
   ...
   String sql8 = "SELECT menu_name from masterdatatable.menu where parent = 1 and menu_name like 'Human Resource' ";
   ...
   String sql9 = "SELECT menu_name from masterdatatable.menu where parent = 1 and menu_name like 'Inventory' ";
   ...
   String sql10 = "SELECT menu_name from masterdatatable.menu where parent = 1 and menu_name like 'Transport' ";
   ...
   String sql11 = "SELECT menu_name from masterdatatable.menu where parent = 2 and menu_name like 'Student Admission' ";
   ...
   Statement stmt12 = con.createStatement();
    ...
    String sql12 = "SELECT menu_name from masterdatatable.menu where parent = 2 and menu_name like 'Time Table' ";
   ...
   Statement stmt13 = con.createStatement();
     ...
     String sql13 = "SELECT menu_name from masterdatatable.menu where parent = 2 and menu_name like 'Attendance' ";
   ...
   Statement stmt14= con.createStatement();
     ...
     String sql14 = "SELECT menu_name from masterdatatable.menu where parent = 2 and menu_name like 'Examination' ";
   ...
   String sql15 = "SELECT menu_name from masterdatatable.menu where parent = 2 and menu_name like 'Placement' ";
   ...
   String sql16 = "SELECT menu_name from masterdatatable.menu where parent = 3 and menu_name like 'Events' ";
   ...
   Statement stmt17 = con.createStatement();
     ...
     String sql17 = "SELECT menu_name from masterdatatable.menu where parent = 3 and menu_name like 'Tasks' ";
   ...
   Statement stmt18 = con.createStatement();
     ...
     String sql18 = "SELECT menu_name from masterdatatable.menu where parent = 3 and menu_name like 'News' ";
   ...
   Statement stmt19 = con.createStatement();
     ...
     String sql19 = "SELECT menu_name from masterdatatable.menu where parent = 3 and menu_name like 'Email' ";
   ...
   String sql20 = "SELECT menu_name from masterdatatable.menu where parent = 4 and menu_name like 'Reports' ";
   ...
   String sql21 = "SELECT menu_name from masterdatatable.menu where parent = 4 and menu_name like 'Custom Reports' ";
   ...
   String sql22 = "SELECT menu_name from masterdatatable.menu where parent = 4 and menu_name like 'Data Export' ";
   ...
   String sql23 = "SELECT menu_name from masterdatatable.menu where parent = 6 and menu_name like 'Manage Course/Batch' ";
   ...
   String sql24 = "SELECT menu_name from masterdatatable.menu where parent = 6 and menu_name like 'Manage Student Category' ";
   ...
   String sql25 = "SELECT menu_name from masterdatatable.menu where parent = 6 and menu_name like 'Add Admission Additional Details' ";
   ...
   String sql26 = "SELECT menu_name from masterdatatable.menu where parent = 6 and menu_name like 'Manage Subjects' ";
   ...
   String sql27 = "SELECT menu_name from masterdatatable.menu where parent = 6 and menu_name like 'SMS Module' ";
   ...
   String sql28 = "SELECT menu_name from masterdatatable.menu where parent = 6 and menu_name like 'Manage Clients' ";
   ...
   String sql29 = "SELECT menu_name from masterdatatable.menu where parent = 6 and menu_name like 'General Settings' ";
   ...
   String sql30 = "SELECT menu_name from masterdatatable.menu where parent = 7 and menu_name like 'Finance Report' ";
   ...
   String sql31 = "SELECT menu_name from masterdatatable.menu where parent = 7 and menu_name like 'Donation' ";
   ...
   String sql32 = "SELECT menu_name from masterdatatable.menu where parent = 7 and menu_name like 'Asset Liability Management' ";
   ...
   String sql33 = "SELECT menu_name from masterdatatable.menu where parent = 7 and menu_name like 'Payslip' ";
   ...
   String sql34 = "SELECT menu_name from masterdatatable.menu where parent = 7 and menu_name like 'Tally Export View' ";
  ...
  Statement stmt35 = con.createStatement();
   ...
   String sql35 = "SELECT menu_name from masterdatatable.menu where parent = 8 and menu_name like 'Settings' ";
  ...
  Statement stmt36 = con.createStatement();
   ...
   String sql36 = "SELECT menu_name from masterdatatable.menu where parent = 8 and menu_name like 'Employee Leave Management' ";
  ...
  Statement stmt37 = con.createStatement();
   ...
   String sql37 = "SELECT menu_name from masterdatatable.menu where parent = 8 and menu_name like 'Employee Search' ";
   ...
   String sql38 = "SELECT menu_name from masterdatatable.menu where parent = 8 and menu_name like 'Employee Management' ";
   ...
   String sql39 = "SELECT menu_name from masterdatatable.menu where parent = 8 and menu_name like 'Create Payslip' ";
   ...
   String sql40 = "SELECT menu_name from masterdatatable.menu where parent = 8 and menu_name like 'Employee Payslip' ";
