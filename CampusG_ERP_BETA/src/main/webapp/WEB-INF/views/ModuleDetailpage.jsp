...
<br/>
<div class="row">
     <form:form method="POST" commandName="module" id="validate"
						action="${pageContext.request.contextPath}/saveModuleDetail">
	   <div class="row">			
			    
			<div class="col-lg-5">
				
                <div class="form-group">
                     <label class="label1">Module Name: </label><span class="style1">*</span>
                            <form:input type="text" path="moduleName"  class="form-control" name="moduleName"   /> 
                </div> 
					
					 <div class="form-group">
                     <label class="label1">Parent Module: </label><span class="style1">*</span>
                     
                     <form:select path="parentId" class="form-control" name="parentId" id="parentId">
							      <form:option value="" label="Select Parent module "/>
                            </form:select>
                     ...
                     <label class="label1">College Name: </label><span class="style1">*</span>
                      ...
                      <form:select path="collegeNamefk" class="form-control" name="collegeNamefk" id="collegeNamefk">
							      <form:option value="" label="Select College Name "/>
                            </form:select>
...
<!-- Core Scripts - Include with every page -->
    ...
    <!-- Dropdown values  -->
   <script src="<c:url value="/resources/js/moduleData.js" />"></script> 
