...
//				country and state index are taken to respective variables from the hidden fields in document
				var countryIndex=$("#countryId").val();
				var stateIndex=$("#stateId").val();
...
//				select box is selected to the value
				$("#presentaddresscountry").val(countryIndex);
				
				//corresponding states for the country
				var state_arr1 = s_a[countryIndex].split("|");
				$.each(state_arr1, function(i, item) {
				...
				//select box is selected to the value
				$("#presentaddressstate").val(stateIndex);
	...
	//*******************************
				...
				var PcountryIndex=$("#PcountryId").val();
				var PstateIndex=$("#PstateId").val();
				$.each(country_arr, function(i, item) {
...
//				select box is selected to the value
				$("#permanentaddresscountry").val(PcountryIndex);
				
				//corresponding states for the country
				var state_arr1 = s_a[PcountryIndex].split("|");
				$.each(state_arr1, function(i, item) {
				...
				//select box is selected to the value
				$("#permanentaddressstate").val(PstateIndex);
				...
				var EcountryIndex=$("#EcountryId").val();
				var EstateIndex=$("#EstateId").val();
				$.each(country_arr, function(i, item) {
...
//				select box is selected to the value
				$("#emergencyaddresscountry").val(EcountryIndex);
				
				//corresponding states for the country
				var state_arr1 = s_a[EcountryIndex].split("|");
				$.each(state_arr1, function(i, item) {
				...
				//select box is selected to the value
				$("#emergencyaddressstate").val(EstateIndex);
				...
				$("#admission").click(function(){
					...
					alert("action is: "+formAction);
					var buttonAction=$(this).attr('name');
					alert("buttonAction: "+buttonAction);
					$("#admissionForm").attr('action',"/CampusG_ERP_BETA/"+buttonAction);
					var formAction=$("#admissionForm").attr('action');
					alert("new action is: "+formAction);
				});
