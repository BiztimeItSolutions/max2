        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
				    ...
				    <h4 class="page-header">Reports | <span class="style2">Exam Schedule Details</span></h4> 
				</div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			<div class="row">
                <div class="col-lg-12">
				    ...
				    <h6>Home>Reports><b>Exam Schedule</b></h6>
				<br>					
				</div>
                <!-- /.col-lg-12 -->
			...
			<br>
			<div align="center"><b>No Exma Group Present</b></div>
