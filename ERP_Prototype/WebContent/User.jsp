        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
				    ...
				    <h4 class="page-header">Manage Users | <span class="style2">Details abour users</span></h4> 
				</div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			<div class="row">
                ...
                <div class="col-lg-6">
                	<div class="bar">
						...
						<a href="User_AddUser.jsp"><button type="button" class="btn btn-primary">Add new</button></a>
					</div>	
				</div>
                <!-- /.col-lg-6 -->
            </div>
