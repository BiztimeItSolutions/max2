        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
				    ...
				    <h4 class="page-header">Reports | <span class="style2">Subject Details</span></h4> 
				</div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			<div class="row">
                ...
                <div class="col-lg-12">
				    ...
				    <h6>Home>Reports><b>Subject Details</b></h6>
					<br>
				</div>
                <!-- /.col-lg-12 -->
				...
				<div class="col-lg-4">
                    ...
                    <label class="label1">Select Course: </label><span class="style1">*</span>
	                    ...
	                    <div class="form-group">
    	                    <label class="label1">Subject Type:</label><span class="style1">*</span>
                	        <div class="boxarea">
							       <label class="checkbox-inline">
        		                     <input type="checkbox">Normal Subject
                    	         </label>
                            	 <label class="checkbox-inline">
                                      <input type="checkbox">Elective Subject
                             	 </label>
							 </div>
							 <br>
                      </div>
			...
			<div class="row">
                <div class="col-lg-12">
				<br>
				<label class="label1">Total Subjects: <b>3</b></label>
                	<div class="bar">
