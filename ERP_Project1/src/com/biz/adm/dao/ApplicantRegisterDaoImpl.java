...
//display shortlisted
	...
	public List<Applicant_Register> getUser()
	{
				...
				//List<Applicant_Register> applicantlist = sessionfactory.getCurrentSession().createQuery("from Applicant_Register WHERE tenth_Percentage>="+tenth_Percentage+" AND twelth_Percentage>="+twelth_Percentage).list();
...
/*		List<Applicant_Register> applicantInterviewlist = sessionfactory.getCurrentSession().createQuery("from Applicant_Register WHERE mail='mail'").list();*/
		List<Applicant_Register> applicantInterviewlist = sessionfactory.getCurrentSession().createQuery("from Applicant_Register WHERE tenth_Percentage>=60 AND twelth_Percentage>=60").list();
