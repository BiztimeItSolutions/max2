...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Work Experience Details</h1>
                </div>
             <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<c:url var="empinfoworkexp" value="updateemployeeworkexp.html"/>
<form:form id="emp_employeeedit_workexp" modelAttribute="employees" commandName="employees" method="get" action="${empinfoworkexp}">
...
<div class="form-group">
                                            ...
                                            <form:input class="form-control" path="emp_ID"  value="${employees.emp_ID}" readonly = "true"/>    
                                        </div>
				...
				<div class="form-group">
                                            ...
                                            <form:input class="form-control" path="designation" value="${employees.designation}" />    
                                        </div>		
                                        <div class="form-group">
                                            <label>Start Date:</label><span class="style1">*</span>
                                            <form:input class="form-control" path="startdate"  value="${employees.startdate}" />    
                                        </div>		
<div class="form-group">
                                            <label>End Date:</label><span class="style1">*</span>
                                            <form:input class="form-control" path="enddate" value="${employees.enddate}"/>    
                                        </div>		
                                        <div class="form-group">
                                            <label>Experience:</label><span class="style1">*</span>
                                            <select class="form-control" name="yearofexperience">
...
<a href="workexpINFo.html" >back to employee details </a><br>
