...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Enter Fee Name </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									<%-- <form id="contactform" method="" action="save_fees.html"> --%>
									<form id="contactform" modelAttribute="fee" method="get" action="save_fees.html">
                                        
										<div class="form-group">
                                            <label>Fee Name: </label><span class="style1">*</span>
                                            <input class="form-control" name="fee_name" placeholder="Enter Fee Name"/>    
                                        </div>
										
										<div class="form-group">
                                            <label>Fee Description: </label><span class="style1">*</span>
                                            <input class="form-control" name="fee_description" placeholder="Enter Fee Description">    
                                        </div>
