                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                 <c:url var="employeeDesignationDetails" value="DesignationInfo.html"/>
                                 <form id="Designation_Details" modelAttribute="employee" method="post" action="${employeeDesignationDetails}">
						...
						<div class="form-group">
                                            ...
                                            <input class="form-control" name="department" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>Date of Joining:</label><span class="style1">*</span>
                                            <input class="form-control" name="doj" id="user" type="date">    
                                        </div>
