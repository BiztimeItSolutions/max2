...
<!--			<div><img src="images/Biztime_Logo.png" width="250" height="60"></div>-->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <c:url var="employeeWorkExperienceDetails" value="WorkExperienceInfo.html"/>
                                 <form id="WorkExperience_Details" modelAttribute="employee" method="post" action="${employeeWorkExperienceDetails}">
		...
		<div class="form-group">
				...
				<div class="form-group">
                                            ...
                                            <input class="form-control" name="designation" id="user">    
                                        </div>		
                                        <div class="form-group">
                                            <label>Start Date:</label><span class="style1">*</span>
                                            <input class="form-control" name="startdate" id="user" type="date">    
                                        </div>		
                                        <div class="form-group">
                                            <label>End Date:</label><span class="style1">*</span>
                                            <input class="form-control" name="enddate" id="user" type="date">    
                                        </div>		
                                        <div class="form-group">
