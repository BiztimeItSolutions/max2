                ...
                <li>
					...
					<li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="morris.html">Online Application Form</a>
                            </li>
                        </ul>
                        </li>
                        </ul>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <c:url var="reg" value="updateInterviewApplicant.html"/>
<form:form id="the-form" modelAttribute="applicant" commandName="applicant" method="get" action="${reg}">
                                 
    

                                     <div class="form-group">
                                            <label> Applicant ID:</label><span class="style1">*</span>
                                           <form:input path="applicant_ID" class="form-control"  value="${applicants.applicant_ID}"/>  
                                        </div>

		                               <div class="form-group">
                                            <label> First Name:</label><span class="style1">*</span>
                                           <form:input path="first_Name" class="form-control"  readonly = "true" value="${applicants.first_Name}"/>  
                                        </div>
                                      
										
										<div class="form-group">
                                            <label> Last name: </label><span class="style1">*</span>
                                          <form:input path="last_Name" class="form-control" readonly = "true" value="${applicants.last_Name}"/>   
                                        </div>
                                      
										
										<div class="form-group">
                                            <label>10th percentage: </label><span class="style1">*</span>
                                           <form:input path="tenth_Percentage" class="form-control" readonly = "true" value="${applicants.tenth_Percentage}"/>   
                                        </div>
										
							
										<div class="form-group">
                                            <label>10th passout Year: </label><span class="style1">*</span>
                                            <form:input path="tenth_YOP" class="form-control" readonly = "true" value="${applicants.tenth_YOP}"/>      
                                        </div>
										
                                        <div class="form-group">
                                            <label>10th School Name:</label><span class="style1">*</span>
                                            <form:input path="tenth_School" class="form-control" readonly = "true" value="${applicants.tenth_School}"/>
                                        </div>
										
										 <div class="form-group">
                                            <label>12th percentage:</label><span class="style1">*</span>
                                           <form:input path="twelth_Percentage" class="form-control" readonly = "true" value="${applicants.twelth_Percentage}"/> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>12th passout Year:</label><span class="style1">*</span>
                                            <form:input path="twelth_YOP" class="form-control" readonly = "true" value="${applicants.twelth_YOP}"/> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>12th School Name:</label><span class="style1">*</span>
                                            <form:input path="twelth_School" class="form-control" readonly = "true" value="${applicants.twelth_School}"/> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Gender:</label><span class="style1">*</span>
                                           <form:input path="gender" class="form-control" readonly = "true" value="${applicants.gender}"/> 
                                        </div>
                                        
                                        <%--  <div class="form-group">
                                            <label>Area Of Interest:</label><span class="style1">*</span>
                                            <form:input path="department" class="form-control" readonly = "true" value="${applicants.department}"/> 
                                        </div> --%>
                                        
                                         <div class="form-group">
                                            <label>Date Of Birth:</label><span class="style1">*</span>
                                          <form:input path="dob" class="form-control" readonly = "true" value="${applicants.dob}"/> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Department:</label><span class="style1">*</span>
                                           <form:input path="department" class="form-control"  value="${applicants.department}"/> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Address Line:</label><span class="style1">*</span>
                                          <form:input path="address" class="form-control"  value="${applicants.address}"/> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>City:</label><span class="style1">*</span>
                                            <form:input path="city" class="form-control" value="${applicants.city}"/> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Pincode:</label><span class="style1">*</span>
                                            <form:input path="pincode" class="form-control" value="${applicants.pincode}"/> 
                                        </div>
                                        
                                        
                                         <%-- <div class="form-group">
                                            <label>State:</label><span class="style1">*</span>
                                         <form:input path="state" class="form-control"  value="${applicants.state}"/> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Country:</label><span class="style1">*</span>
                                           <form:input path="country" class="form-control"  value="${applicants.country}"/> 
                                        </div> --%>
...
<option >Select State</option>
                                         ...
                                         <div class="form-group">
                                          ...
                                          <form:input path="mobile_No" class="form-control"  value="${applicants.mobile_No}"/> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Email ID:</label><span class="style1">*</span>
                                          <form:input path="email_ID" class="form-control"   value="${applicants.email_ID}"/> 
                                        </div>
                                        
                                        
                                         <div class="form-group">
                                            <label>Counseling1:</label><span class="style1">*</span>
                                          <form:input path="counseling1" class="form-control"   value="${applicants.counseling1}"/> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Counseling2:</label><span class="style1">*</span>
                                          <form:input path="counseling2" class="form-control"  value="${applicants.counseling2}"/> 
                                        </div>
                                        <%-- 
                                         <div class="form-group">
                                            <label>status:</label><span class="style1">*</span>
                                          <form:input path="status" class="form-control"  placeholder="selected or Not-selected" value="${applicants.status}"/> 
                                        </div> --%>
<div class="form-group">
                                            <label>Status:</label>
 ...
 <a href="applicantList.html">back</a>
