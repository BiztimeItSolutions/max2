...
<!--			<div><img src="images/Biztime_Logo.png" width="250" height="60"></div>-->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Subject Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <tbody>
									 ...
									 <c:forEach items="${SUBJECT}" var="subject"> 
                                        ...
                                        <tr class="odd gradeX">
											...
											<td><c:out value="${subject.subject_code}"/></td>
											<td><c:out value="${subject.subject_name}"/></td>
											<td>     
										    	<a href="editsubject.html?subject_id=${subject.subject_id}"><img src="images/edit.png" width="14" height="14"></a> | 
												<a href="deletesubject.html?subject_id=${subject.subject_id}"><img src="images/delete16.png" width="14" height="14"></a>
											</td>
                                        </tr> 
                                      </c:forEach>                                     
                                </tbody>
                                </table>
                                <p align="center"><a href="ad_add_subject.html"><img src="images/add.png" width="16" height="16"><strong>&nbsp;Add</strong></a>
                                </p>
                            </div>
                            <!-- /.table-responsive -->
