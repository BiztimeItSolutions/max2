...
<div id="page-wrapper">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                   <c:url var="Registration" value="saveCetApplicant.html"/>
       <form id="the-form" modelAttribute="student" method="post" action="saveCetApplicant.html" role="">
		                               ...
		                               <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  name="cetrank">
                                        </div>
                                        
                                        
                                        
                                         <div class="form-group">
                                            <label>Fee Recipt Number:</label><span class="style1">*</span>
  ...
  <option value="SC/ST">SC/ST</option>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="addrerss">
                                        </div>
