...
<!--			<div><img src="images/Biztime_Logo.png" width="250" height="60"></div>-->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Employee Work Experience Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<td><c:out value="${employee.enddate}"/></td>
<td><c:out value="${employee.yearofexperience}"/></td>
<td>
<a href="editemployeeworkexp.html?id=${employee.id}"><img src="images/edit.png" width="14" height="14"></a> |
<a href="deleteemployeeworkexp.html?id=${employee.id}"><img src="images/delete16.png" width="14" height="14"></a></td>
</tr>
</c:forEach>
</tbody>
</table>
