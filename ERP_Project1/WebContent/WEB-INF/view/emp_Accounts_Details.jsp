        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                 <c:url var="employeeAccountsDetails" value="AccountsInfo.html"/>
                               <form id="Accounts_Details" modelAttribute="employee" method="post" action="${employeeAccountsDetails}">
				...
				<div class="form-group">
                                            ...
                                            <input class="form-control" name="bankname" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>Account Number:</label><span class="style1"></span>
                                            <input class="form-control" name="accountnumber" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>IFSC Code:</label><span class="style1"></span>
                                            <input class="form-control" name="ifsccode" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>Account Type:</label><span class="style1"></span>
                                            <input class="form-control" name="accounttype" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>Branch Name:</label><span class="style1"></span>
                                            <input class="form-control" name="branchname" id="user">    
                                        </div>
