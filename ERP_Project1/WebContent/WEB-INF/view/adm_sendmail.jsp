                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                   <c:url var="reg" value="sendEmaildata.html" />
							<form id="Edit" modelAttribute="student"
								commandName="student" method="post" action="sendEmaildata.html">

								<table border="3" bgcolor="#FFFFFF" width="100" cellspacing="1"
									cellpadding="1">
									<tr>
									
									
										<td>To</td>
										<td><input type="text" path="mail" name="recipient"
												value="${studentsapplicants.mail}" size="25" maxlength="50" />	</td>
