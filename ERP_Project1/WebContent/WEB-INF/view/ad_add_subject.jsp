...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Enter Subject Details </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			...
			<form id="contactform" method="post" action="save_subject.html">
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" name="subject_code" placeholder="Enter Subject Code">    
                                        </div>
										
                                        <div class="form-group">
                                            <label>Subject Name:</label><span class="style1">*</span>
                                            <input class="form-control" name="subject_name" placeholder="Enter Subject Name">
                                        </div>
