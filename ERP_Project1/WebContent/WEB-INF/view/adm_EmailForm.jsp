...
<div id="page-wrapper">
       ...
       <form id="the-form" modelAttribute="" commandName="" method="post" action="sendEmail.html" role="">
	
	
		                               <div class="form-group">
                                            <label> To:</label><span class="style1">*</span>
                                          <input type="text" value="${applicants.email_ID}"  maxlength="4" size="4" class="form-control" placeholder="" name="recipient"> 
                                        </div>
                                      
										
										<div class="form-group">
                                            <label> Subject: </label><span class="style1">*</span>
                                         <input type="text" class="form-control" maxlength="4" size="4"  placeholder="subject" name="subject">  
                                        </div>
                                      
										
										<div class="form-group">
                                            <label>Message: </label><span class="style1">*</span>
                                           <input type="text" class="form-control"  maxlength="4" size="10" placeholder="Enter message" name="message">  
                                        </div>
