...
<div id="page-wrapper">
       ...
       <form id="the-form" modelAttribute="applicant" commandName="applicant" method="get" action="${reg}" role="">
		                               ...
		                               <div class="form-group">
                                           ...
                                           <input path="first_Name" class="form-control" value="${applicants.first_Name}" readonly>  
                                        </div>
                                      
										
										<div class="form-group">
                                            <label> Last name: </label><span class="style1">*</span>
                                          <input path="last_Name" class="form-control" value="${applicants.last_Name}" readonly>   
                                        </div>
                                      
										
										 <div class="form-group">
                                            <label>10th percentage: </label><span class="style1">*</span>
                                           <input path="tenth_Percentage" class="form-control"  value="${applicants.tenth_Percentage}" readonly>   
                                        </div>
										
							
										<div class="form-group">
                                            <label>10th passout Year: </label><span class="style1">*</span>
                                            <input path="tenth_YOP" class="form-control"  value="${applicants.tenth_YOP}" readonly>      
                                        </div>
										
                                        <div class="form-group">
                                            <label>10th School Name:</label><span class="style1">*</span>
                                            <input path="tenth_School" class="form-control" value="${applicants.tenth_School}" readonly>
                                        </div>
										 ...
										 <div class="form-group">
                                           ...
                                           <input path="twelth_Percentage" class="form-control"   value="${applicants.twelth_Percentage}"readonly> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>12th passout Year:</label><span class="style1">*</span>
                                            <input path="twelth_YOP" class="form-control"  value="${applicants.twelth_YOP}" readonly> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>12th School Name:</label><span class="style1">*</span>
                                            <input path="twelth_School" class="form-control"   value="${applicants.twelth_School}"readonly> 
                                        </div>
                                   ...
                                   <%--      
                                      ...
                                      <div class="col-lg-9">
                                      <label>10th Details: </label><span class="style1">*</span>
                                      
				<input path="tenth_School" class="form-control1" value="${applicants.tenth_School}" readonly>
									 <input path="tenth_YOP" class="form-control1"  value="${applicants.tenth_YOP}" readonly>   
								 <input path="tenth_Percentage" class="form-control1"  value="${applicants.tenth_Percentage}" readonly>   
								      
                                      </div></div></div>
										
										 <div class="form-group"> <div class="row">
                                      <div class="col-lg-9">
                                      <label>12th Details: </label><span class="style1">*</span>
                                        
				<input path="twelth_School" class="form-control1" value="${applicants.twelth_School}" readonly>
									 <input path="twelth_YOP" class="form-control1"  value="${applicants.twelth_YOP}" readonly>   
								 <input path="twelth_Percentage" class="form-control1"  value="${applicants.twelth_Percentage}" readonly> 
                                         ...
                                         <div class="form-group">
                                           ...
                                           <input path="gender" class="form-control"   value="${applicants.gender}"readonly> 
                                        </div>
                                         
                                      
                                         <div class="form-group">
                                            <label>Date Of Birth:</label><span class="style1">*</span>
                                          <input path="dob" class="form-control"   value="${applicants.dob}"readonly> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Department:</label><span class="style1">*</span>
                                           <input path="department" class="form-control"  value="${applicants.department}"readonly> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Address Line:</label><span class="style1">*</span>
                                          <input path="address" class="form-control"   value="${applicants.address}"readonly> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>City:</label><span class="style1">*</span>
                                            <input path="city" class="form-control"  value="${applicants.city}"readonly> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Pincode:</label><span class="style1">*</span>
                                            <input path="pincode" class="form-control"  value="${applicants.pincode}"readonly> 
                                        </div>
                                        
                                        
                                         <div class="form-group">
                                            <label>State:</label><span class="style1">*</span>
                                         <input path="state" class="form-control"  value="${applicants.state}"readonly> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Country:</label><span class="style1">*</span>
                                           <input path="country" class="form-control"  value="${applicants.country}"readonly> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Phone Number:</label><span class="style1">*</span>
                                          <input path="mobile_No" class="form-control" value="${applicants.mobile_No}"readonly> 
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Email ID:</label><span class="style1">*</span>
                                          <input path="email_ID" class="form-control"  value="${applicants.email_ID}"readonly> 
                                        </div>
