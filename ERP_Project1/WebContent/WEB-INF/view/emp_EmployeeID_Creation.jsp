...
<!--			<div><img src="images/Biztime_Logo.png" width="250" height="60"></div>-->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
 <c:url var="employeeIDCreation" value="employeeidcreation.html"/>
  <form id="emp_EmployeeID_Creation" modelAttribute="employee" method="post" action="${employeeIDCreation}">
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													...
													&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													&nbsp;&nbsp;&nbsp;&nbsp;               
            <button type="submit" class="btn btn-default">create empid</button>
