...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Online Application Form</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<form id="the-form" modelAttribute="applicant" method="post" action="${Registration}">
...
<h4>Basic Information</h4>
		                               ...
		                               <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" maxlength="60"  placeholder="Enter Your First Name" name="first_Name">  
                                        </div>
                                      
										
										<div class="form-group">
                                            <label> Last Name: </label><span class="style1">*</span>
                                            <input type="text" class="form-control" maxlength="60" placeholder="Enter Your Last Name" name="last_Name">    
                                        </div>
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<input type="radio" name="gender" id="woman" value="Female" /> <label for="woman">Female</label>
                                          ...
                                          <div class="form-group">
                                            <label>Mobile No:</label><span class="style1">*</span>
                                            <input type="text" class="form-control" placeholder="Enter Your mobile_No" name="mobile_No">
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Email ID:</label><span class="style1">*</span>
                                            <input type="text" class="form-control"maxlength="255" placeholder="Enter Your Mail_Id" name="email_ID">
                                        </div>
                             ...
                             <div class="form-group"> <div class="row">
                                <div class="col-lg-9">
                                     	...
                                     	<input type='text' maxlength='200'  class="form-control1" placeholder="School Name" name="tenth_School"/>     
				
									<input type='text' maxlength='4'   class="form-control1" placeholder="year" name="tenth_YOP"/> 
								
							<input type='text' maxlength='2' class="form-control1" placeholder="%" name="tenth_Percentage"/>
                                   </div></div></div>
										  
										    <div class="form-group"><div class="row">
                                <div class="col-lg-9">
                                            <label>12th Details: </label><span class="style1">*</span>
                                       <input type='text' maxlength='200' class="form-control1" placeholder="School Name" name="twelth_School"/>
								
		    						<input type='text' maxlength='4' class="form-control1" placeholder="year" name="twelth_YOP"/>
								
							       	<input type='text' maxlength='2' class="form-control1" placeholder="%" name="twelth_Percentage"/>
			    
                                        </div></div></div>
										  
										<!-- <div class="form-group">
                                            <label>10th Percent: </label><span class="style1">*</span>
                                            <input type="text" class="form-control" placeholder="Enter tenth_Percentage" name="tenth_Percentage">    
                                        </div>
										
										<div class="form-group">
                                            <label>10th Year of Passing: </label><span class="style1">*</span>
                                            <input type="text" class="form-control" placeholder="Enter year of passing" name="tenth_YOP">    
                                        </div>
										
                                        <div class="form-group">
                                            <label>10th School Name:</label><span class="style1">*</span>
                                            <input type="text" class="form-control" placeholder="Enter School Name" name="tenth_School">
                                        </div>
										
										 <div class="form-group">
                                            <label>12th Percentage:</label><span class="style1">*</span>
                                            <input type="text"  class="form-control" placeholder="Enter Percentage" name="twelth_Percentage">
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>12th Year of Passing:</label><span class="style1">*</span>
                                            <input type="text" class="form-control" placeholder="Enter year of passing" name="twelth_YOP">
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>12th School Name:</label><span class="style1">*</span>
                                            <input type="text" class="form-control" placeholder="Enter School Name" name="twelth_School">
                                        </div>
