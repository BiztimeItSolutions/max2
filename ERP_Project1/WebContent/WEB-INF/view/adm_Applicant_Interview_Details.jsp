...
<div id="page-wrapper">
                       <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Applicant Interview Details </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<td><input type="hidden"  name="" value="<c:out value="${applicant.mobile_No}"/>"/></td>
 -->
											...
											<td><a href="editApplicantInterviewDetails.html?applicant_ID=${applicant.applicant_ID}"><img src="images/edit.png" width="14" height="14"></a>  
