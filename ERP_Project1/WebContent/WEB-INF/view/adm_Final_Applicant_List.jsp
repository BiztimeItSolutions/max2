...
<div id="page-wrapper">
                       <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Final List Details </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<td><input type="hidden"  name="" value="<c:out value="${applicant.counseling1}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${applicant.counseling2}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${applicant.status}"/>"/></td>
 -->
           <td> <a href="fetchFinalList.html?applicant_ID=${applicant.applicant_ID}">view</a></td>
