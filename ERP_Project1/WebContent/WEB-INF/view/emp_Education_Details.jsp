...
<head>
  ...
  xmlHttp.send(null);
    ...
    function stateChange(){   
      ...
      document.getElementById("resource1").innerHTML=xmlHttp.responseText;   
      }   
  }
   </script>
...
<!--			<div><img src="images/Biztime_Logo.png" width="250" height="60"></div>-->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                <c:url var="employeeEducationDetails" value="EducationInfo.html"/>
                                 <form id="Education_Details" modelAttribute="employee" method="post" action="${employeeEducationDetails}">
		<div class="form-group">
                                            <label>Employee ID:</label><span class="style1">*</span>
                                            <input class="form-control" name="emp_ID" id="user" value="${emp_ID}" readonly>    
                                        </div>
                
                						<div class="form-group">
                                            <label>Degree Name:</label><span class="style1">*</span>
                                            <input class="form-control" name="degreename" id="user">    
                                        </div>
                                 
						<div class="form-group">
                                            <label>University Name:</label><span class="style1">*</span>
                                            <input class="form-control" name="universityname" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>Percentage:</label><span class="style1">*</span>
                                            <input class="form-control" name="percentage" id="user">    
                                        </div>

		 							<div class="form-group">
                                            <label>Year of Passing:</label><span class="style1">*</span>
                                            <input class="form-control" name="yearofpassing" id="user" type="date">    
                                        </div>
							<div class="form-group">
								 <label>College Name:</label><span class="style1">*</span>
                                            <input class="form-control" name="collegename" id="user">    
                                        </div>
                                        
                                  <div class="form-group">      
                      <label>Education Type:</label><span class="style1">*</span>
				...
				<div class="form-group">
                                            <label>Employee Type:</label><span class="style1">*</span>
	...
	<!--  	<a href="eduINFo.html" >Click Here to see Empolyee Education List</a><br>
            
            <a href="gotodesignation.html" >Click Here to go to next page</a><br>-->
