...
<!--			<div><img src="images/Biztime_Logo.png" width="250" height="60"></div>-->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Fees Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
								...
								<p align="center"><a href="ad_add_fees1.html"><img src="images/add.png" width="16" height="16"><strong>&nbsp;Add</strong></a></p>
                            
     <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                    <!-- <tr rowspan="3">Fee Perticulars</tr> -->
                                        <tr>
                                            <th>Fee ID</th>
                                            <th>Fee Name</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><c:out value="${fees.fee_id}"/></td>
										    <td><c:out value="${fees.fee_name}"/></td>
										    <td><c:out value="${fees.fee_description}"/></td>
											<td>     
										    	<a href="editfees.html?fee_id=${fees.fee_id}"><img src="images/edit.png" width="14" height="14"></a> | 
												<a href="deletefees.html?fee_id=${fees.fee_id}"><img src="images/delete16.png" width="14" height="14"></a>
											</td>
...
<!-- <p align="center"><a href="ad_fees_struct.html"><img src="images/add.png" width="16" height="16"><strong>&nbsp;Add</strong></a></p> -->
                            </div>
                            <!-- /.table-responsive -->
