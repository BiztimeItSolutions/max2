        ...
        <div id="page-wrapper">
            ...
            <!-- /.row -->
                ...
                <div class="form-group">
                                            ...
                                            <input class="form-control" name="first_name" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>Middle Name:</label><span class="style1"></span>
                                            <input class="form-control" name="middle_name" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>Last Name:</label><span class="style1">*</span>
                                            <input class="form-control" name="last_name" id="user">    
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="address_line1" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>Address Line2:</label><span class="style1"></span>
                                            <input class="form-control" name="address_line2" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>City:</label><span class="style1">*</span>
                                            <input class="form-control" name="city" id="user">    
                                        </div>
                <div class="form-group">
                                            <label>Pincode:</label><span class="style1">*</span>
                                            <input class="form-control" name="pincode" id="user">    
                                        </div>
              <div class="form-group">
...
<option >Select State</option>
		...
		<script language="javascript">print_country("country");</script> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="email_ID" id="user">    
                                        </div>
                                        <div class="form-group">
                                            <label>Phone Number:</label><span class="style1">*</span>
                                            <input class="form-control" name="phone_number" id="user">    
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Date of Birth:</label><span class="style1">*</span>
                                            <input class="form-control" name="dob" id="user" type="date">    
                                        </div>
                                         <div class="form-group">
                                            <label>Blood Group:</label><span class="style1">*</span>
                                            <input class="form-control" name="blood_group" id="user">    
                                        </div>
                                         <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" name="nationality" id="user">    
                                        </div>
                                         <div class="form-group">
                                            <label>Govt ID_Number:</label><span class="style1">*</span>
                                            <input class="form-control" name="id_number" id="user">    
                                        </div>
                                         <div class="form-group">
                                            <label>Pan_Card_Number:</label><span class="style1">*</span>
                                            <input class="form-control" name="pan_card_number" id="user">    
                                        </div>
                                        <div class="form-group">
              						...
              						<input class="form-control"type="file" name="photo"/>                    
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="parent_emp_id" id="user">    
                                        </div>
                                        <div class="form-group">
        ...
        <!--     <a href="persoINFo.html" >Click Here to see Empolyee List</a><br>
            <a href="gotoeducation.html" >Click Here to go to next page</a><br>--> 
