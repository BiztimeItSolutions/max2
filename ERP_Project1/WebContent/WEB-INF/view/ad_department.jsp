...
<div id="page-wrapper">
                       <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Department Details </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <p align="center"><a href="ad_add_department.html"><img src="images/add.png" width="16" height="16"><strong>Add</strong></a></p>
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
									   ...
									   <c:forEach items="${DEPT}" var="dept">
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><c:out value="${dept.graduation}"/></td>
                                            <td><c:out value="${dept.department_name}"/></td>
                                            <td><c:out value="${dept.building_name}"/></td>
                                            <td><c:out value="${dept.location}"/></td>
											<td><a href="editdept.html?dept_id=${dept.dept_id}"><img src="images/edit.png" width="14" height="14"></a> | 
												<a href="deletedept.html?dept_id=${dept.dept_id}"><img src="images/delete16.png" width="14" height="14"></a>
											</td>
                                        </tr> 
                                        </c:forEach>                                     
                                    </tbody>
