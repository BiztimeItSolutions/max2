...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Edit Department Details </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<form:form id="editdtud" modelAttribute="department" method="get" action="${reg}">
										...
										<div class="form-group">
                                            <label>Department ID: </label><span class="style1">*</span>
											<form:input class="form-control" path="dept_id" value="${DEPT.dept_id}"/>
										...
										<div class="form-group">
											...
											<select class="form-control" name="graduation">
												...
												<option>Under Graduation-UG</option>
										...
										<div class="form-group">
                                            <label>Department Name: </label><span class="style1">*</span>
                                             <form:input class="form-control" path="department_name" value="${DEPT.department_name}"/>
                                                
                                        </div>
										
										<div class="form-group">
                                            <label>Building Name: </label><span class="style1">*</span>
											<form:input class="form-control" path="building_name" value="${DEPT.building_name}"/>
                                        </div>
										
                                        <div class="form-group">
                                            <label>Location:</label><span class="style1">*</span>
											<form:input class="form-control" path="location" value="${DEPT.location}"/>                                            
