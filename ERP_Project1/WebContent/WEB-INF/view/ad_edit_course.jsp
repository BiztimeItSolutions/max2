...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Edit Course Details </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
							...
							<div class="panel-heading">
                            	<!--Basic Form Elements-->
                            	<!-- <div class="message">Values Added Successfully.</div> -->
...
<c:url var="reg" value="updatecourse.html"/>
<form:form id="editdtud" modelAttribute="course" method="get" action="${reg}">

                                        
										<div class="form-group">
                                            <label>Course ID: </label><span class="style1">*</span>
											
											<form:input class="form-control" path="course_id" value="${COURSE.course_id}" readonly/>
									   ...
									   <form:input class="form-control" path="course_name" value="${COURSE.course_name}"/>
                                       
                                        </div>
										
                                        <div class="form-group">
                                            <label>Course Duration:</label><span class="style1">*</span>
											<form:input class="form-control" path="course_duration" value="${COURSE.course_duration}"/>
                                        </div>
										
										
										<div class="form-group">
                                            <label>Course Size:</label><span class="style1">*</span>
											<form:input class="form-control" path="course_size" value="${COURSE.course_size}"/>
                                        </div>
