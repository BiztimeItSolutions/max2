                ...
                <div class="col-lg-12">
				   ...
				   <div class="form-group">
                                           ...
                                           <form:input path="fname" class="form-control"
												value="${studentsapplicants.fname}"readonly/>
                                        </div>
										...
										<div class="form-group">
                                           ...
                                           <form:input path="fname" class="form-control"
												value="${studentsapplicants.mname}"readonly/>
                                        </div>
										...
										<div class="form-group">
                                            ...
                                            <form:input path="fname" class="form-control"
												value="${studentsapplicants.lname}"readonly />  
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <form:input path="dob" class="form-control"
												value="${studentsapplicants.dob}"readonly/>
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Gender:</label><span class="style1">*</span>
                                            <form:input path="gender" class="form-control"
												value="${studentsapplicants.gender}"readonly/>
                                        </div>
                                        <div class="form-group">
                                            <label>Department:</label><span class="style1">*</span>
                                            <form:input path="branch" class="form-control"
												value="${studentsapplicants.branch}"readonly/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Batch:</label><span class="style1">*</span>
                                            <form:input path="dob" class="form-control"
												value="${studentsapplicants.batch}"readonly/>
                                        </div>
                                        <div class="form-group">
                                            <label>Year:</label><span class="style1">*</span>
                                            <form:input path="dob" class="form-control"
												value="${studentsapplicants.year}"readonly/>
                                        </div>
                                        <div class="form-group">
                                            <label>Sem:</label><span class="style1">*</span>
                                            <form:input path="dob" class="form-control"
												value="${studentsapplicants.sem}"readonly/>
                                        </div>
                                        
										<div class="form-group">
                                            <label>10th Percent: </label><span class="style1">*</span>
                                           <form:input path="per" class="form-control"
												value="${studentsapplicants.per}"readonly />
                                        </div>
										
										<div class="form-group">
                                            <label>Year of Passing: </label><span class="style1">*</span>
                                            <form:input path="per" class="form-control"
												value="${studentsapplicants.yop}"readonly />
                                        </div>
										
                                        <div class="form-group">
                                            <label>Board:</label><span class="style1">*</span>
                                            <form:input path="per" class="form-control"
												value="${studentsapplicants.sname}"readonly />
                                        </div>
										
										 <div class="form-group">
                                            <label>12th Percentage:</label><span class="style1">*</span>
                                            <form:input path="per" class="form-control"
												value="${studentsapplicants.percent}"readonly />
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Year of Passing:</label><span class="style1">*</span>
                                           <form:input path="per" class="form-control"
												value="${studentsapplicants.yearpass}"readonly />
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>12th Board:</label><span class="style1">*</span>
                                            <form:input path="per" class="form-control"
												value="${studentsapplicants.cname}"readonly/>
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>CET Rank:</label><span class="style1">*</span>
                                            <form:input path="per" class="form-control"
												value="${studentsapplicants.cetrank}"readonly/>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Type Of Seat:</label><span class="style1">*</span>
                                            <form:input path="typeofseat" class="form-control"
												value="${studentsapplicants.typeofseat}"readonly/>
                                        </div>
																		
										<div class="form-group">
                                            <label> 10th Certificates: </label><span class="style1">*</span>
                                           <form:input path="fname" class="form-control"
												value="${studentsapplicants.schooldoc}"readonly/>
                                        </div>
										...
										<div class="form-group">
                                           ...
                                           <form:input path="fname" class="form-control"
												value="${studentsapplicants.collegedoc}"readonly/>
                                        </div>
										
										<div class="form-group">
                                            <label>Transfer Certificate: </label><span class="style1">*</span>
                                            <form:input path="fname"  class="form-control"
												value="${studentsapplicants.tc}"readonly/>   
                                        </div>
										
										<div class="form-group">
                                            <label>Seat Allocation Document: </label><span class="style1">*</span>
                                            <form:input path="fname" class="form-control"
												value="${studentsapplicants.cetdoc}"readonly/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <form:input path="fname" class="form-control"
												value="${studentsapplicants.cetbill}"readonly/>
                                        </div>
										
										 <%-- <div class="form-group">
                                            <label>Fee Structure:</label><span class="style1">*</span>
                                            <form:input path="fname" class="form-control"
												value="${studentsapplicants.feestructure}"/>
                                        </div> --%>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <form:input path="city" class="form-control"
												value="${studentsapplicants.address}"readonly/>
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>City:</label><span class="style1">*</span>
                                           <form:input path="city" class="form-control"
												value="${studentsapplicants.city}"readonly/>
                                        </div>
										
										 <div class="form-group">
                                            <label>Country:</label><span class="style1">*</span>
                                          <form:input path="country" class="form-control"
												value="${studentsapplicants.country}"readonly/>
                                        </div>
										 <div class="form-group">
                                            <label>State:</label><span class="style1">*</span>
                                          <form:input path="city" class="form-control"
												value="${studentsapplicants.state}"readonly/>
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>State:</label><span class="style1">*</span>
                                          <form:input path="city" class="form-control"
												value="${studentsapplicants.pincode}"readonly/>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <form:input path="city" class="form-control"
												value="${studentsapplicants.mobile}"readonly/>
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>Email ID:</label><span class="style1">*</span>
                                            <form:input path="city" class="form-control"
												value="${studentsapplicants.mail}"readonly/>
                                        </div>				
							...
							<br> <br> <br> <br> <a
								href="CetStudentList.html">back</a><br>
