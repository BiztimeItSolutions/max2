...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Employee Personal Details</h1>
                </div>
             <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<div class="form-group">
                                            ...
                                            <form:input class="form-control" path="emp_ID"  value="${employees.emp_ID}"/>    
                                        </div>
                
                <div class="form-group">
                                            <label>First Name:</label><span class="style1">*</span>
                                            <form:input class="form-control" path="first_name"  value="${employees.first_name}" />    
                                        </div>
<div class="form-group">
                                            <label>Middle Name:</label><span class="style1"></span>
                                            <form:input class="form-control" path="middle_name"  value="${employees.middle_name}"/>    
                                        </div>
                                        <div class="form-group">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <form:input class="form-control"  path="gender"  value="${employees.gender}"/>    
                                        </div>
...
<div class="form-group">
            ...
            <div class="form-group">
                                            ...
                                            <form:input  class="form-control"  path="country"  value="${employees.country}"/>    
                                        </div>
                                        <div class="form-group">
                                            <label>State:</label><span class="style1">*</span>
                                            <form:input  class="form-control"  path="state"  value="${employees.state}"/>    
                                        </div>
...
<div class="form-group">
                                       ...
                                       <div class="form-group">
                                            <label>Marital Status:</label><span class="style1">*</span>
                                            <form:input class="form-control"  path="marital_status"  value="${employees.marital_status}"/>    
                                        </div><div class="form-group">
                                        
                                            <label>Caste:</label><span class="style1">*</span>
                                            <form:input class="form-control"  path="caste"  value="${employees.caste}"/>    
 ...
 <div class="form-group">
              					...
              					<form:input class="form-control"  path="photo"  value="${employees.photo}"/>                   
