...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Enter Department Details </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">2
									...
									<form role="form" id="contactform" method="post" action="save_department.html">
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" name="department_name" placeholder="Ex:Department Name-UG/PG">    
                                        </div>
										
										<div class="form-group">
                                            <label>Building Name: </label><span class="style1">*</span>
                                            <input class="form-control" name="building_name" placeholder="Enter Building Name">    
                                        </div>
										
                                        <div class="form-group">
                                            <label>Location:</label><span class="style1">*</span>
                                            <input class="form-control" name="location" placeholder="Enter Location Name">
                                        </div>
