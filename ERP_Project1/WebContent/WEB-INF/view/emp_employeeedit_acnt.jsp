...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Accounts Details</h1>
                </div>
             <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<c:url var="empinfoacnt" value="updateemployeeacnt.html"/>
<form:form id="emp_employeeedit_acnt" modelAttribute="employees" commandName="employees" method="get" action="${empinfoacnt}">
...
<div class="form-group">
				...
				<div class="form-group">
                                            <label>Bank Name:</label><span class="style1"></span>
                                            <form:input class="form-control" path="bankname"  value="${employees.bankname}"/>    
                                        </div>
                                        <div class="form-group">
                                            <label>Account Number:</label><span class="style1"></span>
                                            <form:input class="form-control" path="accountnumber" value="${employees.accountnumber}"/>    
                                        </div>
                                        <div class="form-group">
                                            <label>IFSC Code:</label><span class="style1"></span>
                                            <form:input class="form-control" path="ifsccode" value="${employees.ifsccode}"/>    
                                        </div>
                                        <div class="form-group">
                                            <label>Account Type:</label><span class="style1"></span>
                                            <form:input class="form-control" path="accounttype"  value="${employees.accounttype}"/>    
                                        </div>
                                        <div class="form-group">
                                            <label>Branch Name:</label><span class="style1"></span>
                                            <form:input class="form-control" path="branchname" value="${employees.branchname}"/>    
                                        </div>
...
<td>
<form:input path="bankname"  value="${employees.bankname}" size="25" maxlength="50" /> 
</td>
<td>
<form:input path="accountnumber" value="${employees.accountnumber}" size="25" maxlength="50" /> 
</td>
<td>
<form:input path="ifsccode" value="${employees.ifsccode}" size="25" maxlength="50" /> 
</td>
<td>
<form:input path="accounttype"  value="${employees.accounttype}" size="25" maxlength="50" /> 
</td>
<td>
<form:input path="branchname" value="${employees.branchname}" size="25" maxlength="50" /> 
</td>
...
<a href="acntINFo.html" >back to employee details </a><br>
