...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Education Details</h1>
                </div>
             <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
<c:url var="empinfoedu" value="updateemployeeedu.html"/>
<form:form id="emp_employeeedit_edu" modelAttribute="employees" commandName="employees" method="get" action="${empinfoedu}">

<div class="form-group" hidden>
                                            <label>ID:</label><span class="style1">*</span>
                                            <form:input class="form-control" path="id"  value="${employees.id}"/>    
                                        </div>
...
<div class="form-group">
                						...
                						<div class="form-group">
                                            ...
                                            <form:input class="form-control" path="degreename"  value="${employees.degreename}"/>    
                                        </div>
                                 
						<div class="form-group">
                                            <label>University Name:</label><span class="style1">*</span>
                                            <form:input class="form-control" path="universityname" value="${employees.universityname}"/>    
                                        </div>
                                        <div class="form-group">
                                            <label>Percentage:</label><span class="style1">*</span>
                                            <form:input class="form-control" path="percentage" value="${employees.percentage}" />    
                                        </div>

		 							<div class="form-group">
                                            <label>Year of Passing:</label><span class="style1">*</span>
                                            <form:input class="form-control" path="yearofpassing" value="${employees.yearofpassing}"/>    
                                        </div>
							<div class="form-group">
								 <label>College Name:</label><span class="style1">*</span>
                                            <form:input class="form-control" path="collegename"  value="${employees.collegename}" />    
                                        </div>
...
<a href="eduINFo.html" >back to employee education details </a><br>
