...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Enter Course Details </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									<form role="form" id="contactform" method="post" action="save_course.html">
                                        
										<!-- <div class="form-group">
                                            <label>Graduation:</label>
                                            <span class="style1">*</span>
											<select class="form-control" name="graduation" onChange="showResources(this.value)"/>
 										...
 										<!-- <div class="form-group">
                                            <label>Department Name: </label><span class="style1">*</span>
											<select class="form-control" name="department_name" id="resource1" >
										  ...
										  <div class="form-group">
											...
											<select class="form-control" name="department_name">
                                                ...
                                                <option><c:out value="${dept.department_name}"/></option>
                                                </c:forEach>
                                            </select>
                                        </div> 
										...
										<div class="form-group">
                                            <label>Course Name: </label><span class="style1">*</span>
                                            <input class="form-control" name="course_name" placeholder="Enter Course Name">    
                                        </div>
										
                                        <div class="form-group">
                                            <label>Course Duration:</label><span class="style1">*</span>
                                            <input class="form-control" name="course_duration" placeholder="Enter Course Duration">
                                        </div>
									
										
										<div class="form-group">
                                            <label>Course Size:</label><span class="style1">*</span>
                                            <input class="form-control" name="course_size" placeholder="Enter Course Size">
                                        </div>
