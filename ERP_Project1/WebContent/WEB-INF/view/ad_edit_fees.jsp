...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Edit Fee Perticular </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<c:url var="reg" value="updatefees.html"/>
<form:form id="editdtud" modelAttribute="fees" method="get" action="${reg}">

                                        
										<div class="form-group">
                                            <label>Fees ID: </label><span class="style1">*</span>
											
											<form:input class="form-control" path="fee_id" value="${FEES.fee_id}" readonly/>

                                        </div>
										
										<div class="form-group">
                                            <label>Fees Name: </label><span class="style1">*</span>
											
											<form:input class="form-control" path="fee_name" value="${FEES.fee_name}" readonly/>

                                        </div>
										
										<div class="form-group">
                                            <label>Fees Description: </label><span class="style1">*</span>
											
											<form:input class="form-control" path="fee_description" value="${FEES.fee_description}" readonly/>
