...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Designation Details</h1>
                </div>
             <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<c:url var="empinfodesig" value="updateemployeedesig.html"/>
<form:form id="emp_employeeedit_desig" modelAttribute="employees" commandName="employees" method="get" action="${empinfodesig}">
...
<div class="form-group">
						...
						<div class="form-group">
                                            ...
                                            <form:input class="form-control" path="department" value="${employees.department}" />    
                                        </div>
                                        <div class="form-group">
                                            <label>Date of Joining:</label><span class="style1">*</span>
                                            <form:input class="form-control" path="doj" value="${employees.doj}"/>    
                                        </div>
...
<a href="desigINFo.html" >back to employee details </a><br>
