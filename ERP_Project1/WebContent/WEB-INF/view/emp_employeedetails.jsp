...
<!--			<div><img src="images/Biztime_Logo.png" width="250" height="60"></div>-->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">Employee Personal Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<%-- <td><input type="hidden"  name="" value="<c:out value="${employee.middle_name}"/>"/></td> --%>
<td><c:out value="${employee.last_name}"/></td>
<td><c:out value="${employee.gender}"/></td>

<%-- <td><input type="hidden"  name="" value="<c:out value="${employee.address_line1}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.address_line2}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.city}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.state}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.country}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.pincode}"/>"/></td> --%>

<td><c:out value="${employee.email_ID}"/></td>
<td><c:out value="${employee.phone_number}"/></td>

<%-- <td><input type="hidden"  name="" value="<c:out value="${employee.dob}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.blood_group}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.marital_status}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.caste}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.nationality}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.id_number}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.pan_card_number}"/>"/></td>
<td><input type="hidden"  name="" value="<c:out value="${employee.photo}"/>"/></td> --%>

<td><c:out value="${employee.parent_emp_id}"/></td>
<td><c:out value="${employee.user_ID}"/></td>
<td><c:out value="${employee.password}"/></td>
 <td><a href="fetchemployee.html?id=${employee.id}">view</a></td>
<td>
<a href="editemployee.html?id=${employee.id}"><img src="images/edit.png" width="14" height="14"></a> | 
<a href="deleteemployee.html?id=${employee.id}"><img src="images/delete16.png" width="14" height="14"></a></td>
</tr>
</c:forEach>
</tbody>
</table>
