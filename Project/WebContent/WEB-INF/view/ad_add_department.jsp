...
<ul>
    ...
    <div id="contentRight">
      ...
      <div  class="form">
			...
			<form id="contactform" method="post" action="save_department.html">
    		
				<p class="contact">
				  <label for="name">Department Name</label>
				<span class="style1">*</span></p> 
    			<input id="name" name="departmentt_name" placeholder="" required="" tabindex="1" type="text"> 
    			 
    			<p class="contact">
    			  <label for="email">Building Name </label>
    			  <span class="style1">*</span></p> 
    			<input id="email" name="building_name" placeholder="" required="" type="text"> 
                
                <p class="contact">
                  <label for="username">Location</label>
                  <span class="style1">*</span></p> 
    			<input id="username" name="location" placeholder="" required="" tabindex="2" type="text"> <br></br>
