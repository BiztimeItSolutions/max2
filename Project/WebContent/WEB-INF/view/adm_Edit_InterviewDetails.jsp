...
<td>
<form:input path="counseling1" placeholder="sent" value="${applicants.counseling1}" size="25" maxlength="50" /> 
</td>

<td>
<form:input path="counseling2" placeholder="sent" value="${applicants.counseling2}" size="25" maxlength="50" /> 
</td>

<td>
<form:input path="status" placeholder="sent" value="${applicants.status}" size="25" maxlength="50" /> 
</td>
...
<a href="applicantInterviewList.html" >back </a><br>
