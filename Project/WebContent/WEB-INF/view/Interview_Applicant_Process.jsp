...
<body>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img
					src="Biztime_Logo.png" width="200" height="50"></a>
			</div>
			<!-- /.navbar-header -->
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu dropdown-user">
						<li><a href="#"><i class="fa fa-user fa-fw"></i> User
								Profile</a></li>
						<li><a href="settings.html"><i class="fa fa-gear fa-fw"></i>
								Settings</a></li>
						<li class="divider"></li>
						<li><a href="adm_mainpage.html"><i class="fa fa-sign-out fa-fw"></i>
								Logout</a></li>
					</ul> <!-- /.dropdown-user --></li>
				<!-- /.dropdown -->
			</ul>
							...
							<div class="row">
								<div class="col-lg-6">
									<form id="studentform" name="registerform" action="" method=""
										onsubmit="return registerForm('registerform')">

										<table id="data tabel" border="1">
											...
											<tr>
												<td><a href="Applicant_Interview_Details.jsp">1</a></td>
												<td>Soumya</td>
												<td>Nayak</td>
    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="sidebar-search">
                     ...
                     <li>
                        <a href="Student_Personal_Profile.jsp"><i class="fa fa-dashboard fa-fw"></i>Personal Details</a>
                    </li>
                    <li>
                         <a href="StudentAdmission.jsp"><i class="fa fa-dashboard fa-fw"></i>Admission Details</a>
                    </li>    
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Shortlist Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                 <form id="studentform" name="registerform" action="" method="" onsubmit="return registerForm('registerform')">
		                          ...
		                          <th>First Name</th>
		                           ...
		                           <tr>
		                           <td><a href="Applicant_Details.jsp">1</a></td>
		                          <td>Soumya</td>
		                           <td>Nayak</td>
