      ...
      <li>
		...
		<fieldset>
			...
			<p>
				...
				<label for="mname" class="block">Designation:</label>
				 <span class="style1">                                            *</span>
				...
				<label for="lname" class="block">Department:</label>
				 <span class="style1">                                            *</span>
                                            
                                          <table width="1015">
                                              <tr>
                                               <td width="608">
                                                 <div class="form-group"><input class="form-control" name="department" id="user"></div>
				...
				<span class="style1">        *</span>
                                          ...
                                          <table width="1015">
                                              <tr>
                                               <td width="608">
                                                 <div class="form-group"><input class="form-control" name="doj" id="user" type="date"></div>
		...
		<p>
			<button type="submit" id="send"><a href="Work_Experience_Details.jsp">Next</a></button>
		</p>
